(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["pages-payId-beneficiary-list-payId-beneficiary-list-module"], {
    /***/
    "2ery":
    /*!*****************************************************************************************************************************!*\
    ...
    "hAaB":
    /*!*******************************************************************************!*\
      !*** ./src/app/pages/payId-beneficiary-list/payId-beneficiary-list.module.ts ***!
      \*******************************************************************************/

    /*! exports provided: PayIdBeneficiaryListPageModule */

    /***/
    function hAaB(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "PayIdBeneficiaryListPageModule", function () {
        return PayIdBeneficiaryListPageModule;
      });
      /* harmony import */
      ...
      var _payId_beneficiary_list_page__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
      /*! ./payId-beneficiary-list.page */
      "0I+0");

      var routes = [{
        path: '',
        component: _payId_beneficiary_list_page__WEBPACK_IMPORTED_MODULE_7__["PayIdBeneficiaryListPage"]
      }];

      var PayIdBeneficiaryListPageModule = /*#__PURE__*/_createClass(function PayIdBeneficiaryListPageModule() {
        _classCallCheck(this, PayIdBeneficiaryListPageModule);
      });

      PayIdBeneficiaryListPageModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        imports: [src_app_commonSRC_shared_module__WEBPACK_IMPORTED_MODULE_6__["SharedModule"], src_app_commonSRC_psTemplates_ps_template_view_ps_template_view_template_module__WEBPACK_IMPORTED_MODULE_5__["PsTemplateViewModule"], _angular_router__WEBPACK_IMPORTED_MODULE_2__["RouterModule"].forChild(routes), src_app_commonSRC_psComponents_ps_components_module__WEBPACK_IMPORTED_MODULE_4__["PsComponentsModule"], src_app_commonBussinessSRC_psComponents_ps_beneficiary_ps_payId_beneficiary_ps_payId_beneficiary_component_module__WEBPACK_IMPORTED_MODULE_3__["PsPayIdBeneficiaryComponentModule"]],
        declarations: [_payId_beneficiary_list_page__WEBPACK_IMPORTED_MODULE_7__["PayIdBeneficiaryListPage"]]
      })], PayIdBeneficiaryListPageModule);
      /***/
    }
  }]);
})();
//# sourceMappingURL=pages-payId-beneficiary-list-payId-beneficiary-list-module-es5.js.map