(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([[30], {
    ...
    /***/
    function gGU(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    "3otj":
    /*!*******************************************************************************!*\
      !*** ./src/app/pages/activate-soft-token-otp/activate-soft-token-otp.page.ts ***!
      \*******************************************************************************/

    /*! exports provided: ActivateSoftTokenOtpPage */

    /***/
    function otj(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "ActivateSoftTokenOtpPage", function () {
        return ActivateSoftTokenOtpPage;
      });
      /* harmony import */
      ...
      var _raw_loader_activate_soft_token_otp_page_html__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
      /*! raw-loader!./activate-soft-token-otp.page.html */
      "emUr");
      /* harmony import */


      var _activate_soft_token_otp_page_scss__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
      /*! ./activate-soft-token-otp.page.scss */
      "+gGU");
      /* harmony import */
      ...
      var ActivateSoftTokenOtpPage = /*#__PURE__*/function (_src_app_pages_omni_b) {
        function ActivateSoftTokenOtpPage(navService, omniPull) {
          var _this;

          _classCallCheck(this, ActivateSoftTokenOtpPage);

          _this = _callSuper(this, ActivateSoftTokenOtpPage);
          _this.navService = navService;
          _this.omniPull = omniPull;
          _this.formGroup = new _angular_forms__WEBPACK_IMPORTED_MODULE_4__["FormGroup"]({});
          _this.softTokenScreenVO = {};
          _this.templateFormOptions = {
            group: _this.formGroup,
            submitOptions: {
              extraParams: {},
              group: _this.formGroup,
              submitServiceUrl: src_app_commonBussinessSRC_psServices_models_ps_commonBusiness_settings__WEBPACK_IMPORTED_MODULE_6__["PsCommonBusinessSettings"].serviceUrl.activateSoftToken,
              preCallFunction: {
          ...
          _this.stepperOptions = {
            ...
            stepperName: 'activate_soft_token_otp_stepper',
            numberOfSteps: 2,
            namesofSteps: ['activate_soft_token_otp_hints_step', 'activate_soft_token_vasco'],
            group: _this.formGroup,
            submitOptions: {
              group: _this.formGroup,
              submitServiceUrl: src_app_commonBussinessSRC_psServices_models_ps_commonBusiness_settings__WEBPACK_IMPORTED_MODULE_6__["PsCommonBusinessSettings"].serviceUrl.activateSoftToken,
              preCallFunction: {
                func: function func(response) {
                  ...
                  return new Promise(function (resolve, reject) {
                    resolve(_this3.executionClass.updateVO(response));
                  });
                },
                executionClass: _this,
                params: [_this]
            ...
            requestObject: _this.softTokenScreenVO,
            showReport: false
          };
          _this.activateSoftTokenDetailsPanelOptions = {
            isExpandable: true,
            labelKey: 'activate_soft_token_otp_key',
            iconName: 'document',
            expanded: true
          };
          _this.activateSoftTokenVascoPanelOptions = {
            isExpandable: true,
            labelKey: 'activate_soft_token_otp_key',
            iconName: 'document',
            expanded: true
          };
          _this.activateSoftTokenStepsLblOptions = {
            fcName: 'activateSoftTokenSteps',
            labelKey: 'activate_soft_token_steps_key'
          };
          _this.softTokenHintLblOptions = {
            fcName: 'softTokenHint',
            labelKey: 'soft_token_otp_can_be_activated_on_3_devices_at_maximum_key'
          };
          _this.crontoDetailsPanelOptions = {
            isExpandable: true,
            labelKey: 'cronto_details_key',
            iconName: 'document',
            expanded: true
          };
          _this.complexVascoSoftTokenOptions = {
            disableSoftTokenBtn: false,
            activateSoftTokenOptions: {
              labelKey: 'activate_soft_token_key',
              type: 'button',
              psClass: 'ps-button-activate',
              group: _this.formGroup
            },
            crontoImageOptions: {
              imageName: ''
            ...
            crontoCodeOptions: {
              group: _this.formGroup,
              labelKey: 'cronto_code_key',
              placeHolder: 'cronto_code_key',
              fcName: 'crontoCode'
            }
          };
          return _this;
        ...
        _inherits(ActivateSoftTokenOtpPage, _src_app_pages_omni_b);

        return _createClass(ActivateSoftTokenOtpPage, [{
          key: "ngOnInit",
          value: function ngOnInit() {
            this.commonProv.copyObject(this.softTokenScreenVO, this.navService.getAllParams() ? this.navService.getAllParams() : {});
            this.commonProv.applyDynScreenDisplay(src_app_commonSRC_psServices_models_common_constant__WEBPACK_IMPORTED_MODULE_8__["ConstantCommon"].ACTION_TYPE_VISIBLE, [this.stepperOptions.stepperName + '_preview', this.stepperOptions.stepperName + '_terms'], 0);
          } //Edited by Marina jira-AZDB-1398; check if the soft token is enabled in ionViewDidEnter so when the user re-enter the screen the button is enabled as we disable it after the cronto image is displayed in ps-complex-soft-token
          ...
          value: function ionViewDidEnter() {
            ...
            _superPropGet(ActivateSoftTokenOtpPage, "ionViewDidEnter", this, 3)([]);

            this.commonProv.presentLoading();
            this.omniPull.getParamValOf(src_app_commonBussinessSRC_psServices_models_ps_common_bussiness_constant__WEBPACK_IMPORTED_MODULE_5__["CommonBussinessConstant"].ENABLE_SOFT_TOKEN_OTP).then(function (res) {
              if (res[src_app_commonBussinessSRC_psServices_models_ps_common_bussiness_constant__WEBPACK_IMPORTED_MODULE_5__["CommonBussinessConstant"].ENABLE_SOFT_TOKEN_OTP]) {
                _this4.complexVascoSoftTokenOptions.disableSoftTokenBtn = false;

                _this4.commonProv.applyDynScreenDisplay(src_app_commonSRC_psServices_models_common_constant__WEBPACK_IMPORTED_MODULE_8__["ConstantCommon"].ACTION_TYPE_READONLY, ['activate_soft_token_btn'], 0);
              }
            })["finally"](function () {
              _this4.commonProv.dismissLoading();
            });
          } //added by Marina jira-AZDB-1400; add the cronto code value to "value" property as requested by Hasan F.

        }, {
          key: "updateVO",
          value: function updateVO() {
            this.softTokenScreenVO['value'] = this.softTokenScreenVO[this.complexVascoSoftTokenOptions.crontoCodeOptions.fcName];
          }
        }]);
      }(src_app_pages_omni_base_omni_base_page__WEBPACK_IMPORTED_MODULE_10__["OmniBasePage"]);

      ActivateSoftTokenOtpPage.ctorParameters = function () {
        return [{
      ...
      ActivateSoftTokenOtpPage = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_3__["Component"])({
        selector: 'activate-soft-token-otp',
        template: _raw_loader_activate_soft_token_otp_page_html__WEBPACK_IMPORTED_MODULE_1__["default"],
        styles: [_activate_soft_token_otp_page_scss__WEBPACK_IMPORTED_MODULE_2__["default"]]
      }), Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:paramtypes", [src_app_commonSRC_psServices_navigator_ps_navigator_service__WEBPACK_IMPORTED_MODULE_9__["PsNavigatorService"], src_app_commonBussinessSRC_psServices_omni_common_omni_pull_service__WEBPACK_IMPORTED_MODULE_7__["OmniPullService"]])], ActivateSoftTokenOtpPage);
      /***/
    },
    ...
    "emUr":
    /*!***********************************************************************************************************************!*\
      !*** ./node_modules/raw-loader/dist/cjs.js!./src/app/pages/activate-soft-token-otp/activate-soft-token-otp.page.html ***!
      \***********************************************************************************************************************/

    /*! exports provided: default */

    /***/
    function emUr(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_exports__["default"] = "<ps-template-stepper [options]=\"stepperOptions\" [id]=\"stepperOptions.stepperName\">\n  <ps-form-step *psStep=\"'step1'\" step1 [id]=\"stepperOptions.namesofSteps[0]\">\n    <ps-container-panel [options]=\"activateSoftTokenDetailsPanelOptions\" id=\"activate_soft_token_details_panel\">\n      <ps-label [options]=\"activateSoftTokenStepsLblOptions\"></ps-label>\n      <ps-label [options]=\"softTokenHintLblOptions\"></ps-label>\n    </ps-container-panel>\n  </ps-form-step>\n  <ps-form-step *psStep=\"'step2'\" step2 [id]=\"stepperOptions.namesofSteps[1]\">\n    <ps-container-panel [options]=\"activateSoftTokenVascoPanelOptions\" id=\"activate_soft_token_vasco_panel\">\n      <ps-complex-vasco-soft-token [options]=\"complexVascoSoftTokenOptions\"></ps-complex-vasco-soft-token>\n    </ps-container-panel>\n  </ps-form-step>\n\n</ps-template-stepper>";
      /***/
    },
        ...
        return _createClass(OmniBasePage, [{
            ...
            if (formGroup !== undefined && this.customizationMap) {
              ...
              if (formDisObj && formDisObj.IS_READONLY === 1 && formGroup.status != 'DISABLED') {
                ...
                Object.keys(formGroup.controls).forEach(function (key) {
                  _this5.commonProv.applyDynScreenDisplay(src_app_commonSRC_psServices_models_common_constant__WEBPACK_IMPORTED_MODULE_5__["ConstantCommon"].ACTION_TYPE_READONLY, [key], 1);
                });
              }
            }
          }
          ...
          value: function ngAfterViewChecked() {
            ...
            if (!this.isPageDisabled) {
              setTimeout(function () {
                _this6.disableForm(_this6.baseFormGroup);

                _this6.isPageDisabled = true;
              }, 300);
            }
