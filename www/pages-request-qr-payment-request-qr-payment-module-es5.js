(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["pages-request-qr-payment-request-qr-payment-module"], {
    /***/
    "HbOp":
    /*!*******************************************************************************************************!*\
    ...
    "iP+J":
    /*!***********************************************************************!*\
      !*** ./src/app/pages/request-qr-payment/request-qr-payment.module.ts ***!
      \***********************************************************************/

    /*! exports provided: RequestQrPaymentPageModule */

    /***/
    function iPJ(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "RequestQrPaymentPageModule", function () {
        return RequestQrPaymentPageModule;
      });
      /* harmony import */
      ...
      var _request_qr_payment_page__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(
      /*! ./request-qr-payment.page */
      "Evj/");

      var routes = [{
        path: '',
        component: _request_qr_payment_page__WEBPACK_IMPORTED_MODULE_11__["RequestQrPaymentPage"]
      }];

      var RequestQrPaymentPageModule = /*#__PURE__*/_createClass(function RequestQrPaymentPageModule() {
        _classCallCheck(this, RequestQrPaymentPageModule);
      });

      RequestQrPaymentPageModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        imports: [src_app_commonSRC_shared_module__WEBPACK_IMPORTED_MODULE_10__["SharedModule"], src_app_commonSRC_psTemplates_ps_template_stepper_ps_template_stepper_template_module__WEBPACK_IMPORTED_MODULE_9__["PsTemplateStepperModule"], _angular_router__WEBPACK_IMPORTED_MODULE_2__["RouterModule"].forChild(routes), src_app_commonSRC_psComponents_ps_components_module__WEBPACK_IMPORTED_MODULE_8__["PsComponentsModule"], src_app_commonBussinessSRC_psComponents_ps_lookup_ps_lookup_own_accounts_ps_lookup_own_accounts_component_module__WEBPACK_IMPORTED_MODULE_7__["PsLookupOwnAccountComponentModule"], src_app_commonBussinessSRC_psComponents_ps_keyin_input_ps_input_varchar_ps_input_varchar_component_module__WEBPACK_IMPORTED_MODULE_6__["PsInputVarcharComponentModule"], src_app_commonBussinessSRC_psComponents_ps_complex_components_ps_complex_exchange_ps_complex_exchange_component_module__WEBPACK_IMPORTED_MODULE_5__["PsComplexExchangeComponentModule"], src_app_commonBussinessSRC_psComponents_ps_accounts_list_ps_accounts_list_component_module__WEBPACK_IMPORTED_MODULE_3__["PsAccountsListComponentModule"], src_app_commonBussinessSRC_psComponents_ps_complex_components_ps_complex_amount_ps_complex_amount_component_module__WEBPACK_IMPORTED_MODULE_4__["PsComplexAmountComponentModule"]],
        declarations: [_request_qr_payment_page__WEBPACK_IMPORTED_MODULE_11__["RequestQrPaymentPage"]],
        exports: [_request_qr_payment_page__WEBPACK_IMPORTED_MODULE_11__["RequestQrPaymentPage"]],
        entryComponents: [_request_qr_payment_page__WEBPACK_IMPORTED_MODULE_11__["RequestQrPaymentPage"]],
        schemas: [_angular_core__WEBPACK_IMPORTED_MODULE_1__["CUSTOM_ELEMENTS_SCHEMA"]]
      })], RequestQrPaymentPageModule);
      /***/
    }
  }]);
})();
//# sourceMappingURL=pages-request-qr-payment-request-qr-payment-module-es5.js.map