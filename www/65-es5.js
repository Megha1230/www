(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([[65], {
    ...
    /***/
    function sGz(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "ContactBankPage", function () {
      ...
      var _raw_loader_contact_bank_page_html__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
      /*! raw-loader!./contact-bank.page.html */
      "hPqG");
      /* harmony import */
      ...
      var ContactBankPage = /*#__PURE__*/function (_omni_base_omni_base_) {
        function ContactBankPage(commonService, logger) {
          var _this;

          _classCallCheck(this, ContactBankPage);

          _this = _callSuper(this, ContactBankPage);
        ...
        _inherits(ContactBankPage, _omni_base_omni_base_);

        return _createClass(ContactBankPage, [{
          key: "ngOnInit",
          value: function ngOnInit() {
            _superPropGet(ContactBankPage, "init", this, 3)([]);

            this.baseFormGroup = this.formGroup;

            if (src_app_commonSRC_psServices_models_ps_common_settings__WEBPACK_IMPORTED_MODULE_7__["PsCommonSettings"].isLoggedIn) {
              var userInfo = this.commonService.session.getValueOf(src_app_commonSRC_psServices_models_common_constant__WEBPACK_IMPORTED_MODULE_6__["ConstantCommon"].USERINFO);
              this.options.requestObject[this.emailOptions.fcName] = userInfo.omniUserVO.EMAIL;
              this.options.requestObject[this.nameOptions.fcName] = userInfo.customerInfoCO.customerName || userInfo.customerInfoCO.shortName; //TP #1382386 giving the phone number a value makes it appear in the summary when it's hidden from the admin    
              //jira-8402 - Make sure to validate validity from CUST to avoid phone number to appear in summary in hidden

              var mobileCust = this.commonProv.getElementValidations(this.phoneNumberOptions.fcName);
              ...
              if (this.options.requestObject[this.phoneNumberOptions.fcName] == undefined) {
                var phoneNbVal = userInfo.customerInfoCO.userMobileNumber;
      ...
      ContactBankPage.ctorParameters = function () {
        return [{
      ...
      ContactBankPage = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["Component"])({
        selector: 'contact-bank',
        template: _raw_loader_contact_bank_page_html__WEBPACK_IMPORTED_MODULE_1__["default"]
      }), Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:paramtypes", [src_app_commonSRC_psServices_ps_common_ps_common_service__WEBPACK_IMPORTED_MODULE_8__["PsCommonService"], src_app_commonSRC_psServices_logger_logger_service__WEBPACK_IMPORTED_MODULE_5__["LoggerService"]])], ContactBankPage);
      /***/
    },
    ...
    /***/
    function hPqG(module, __webpack_exports__, __webpack_require__) {
      "use strict";
