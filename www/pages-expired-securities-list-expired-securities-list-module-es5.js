(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["pages-expired-securities-list-expired-securities-list-module"], {
    /***/
    "2ery":
    /*!*****************************************************************************************************************************!*\
    ...
    "inhu":
    /*!*********************************************************************************!*\
      !*** ./src/app/pages/expired-securities-list/expired-securities-list.module.ts ***!
      \*********************************************************************************/

    /*! exports provided: ExpiredSecuritiesListPageModule */

    /***/
    function inhu(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "ExpiredSecuritiesListPageModule", function () {
        return ExpiredSecuritiesListPageModule;
      });
      /* harmony import */
      ...
      var src_app_commonBussinessSRC_psComponents_ps_container_lookup_option_ps_option_expired_security_ps_option_expired_security_component_module__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
      ...
      var _expired_securities_list_page__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
      /*! ./expired-securities-list.page */
      "Qr3S");

      var routes = [{
        path: '',
        component: _expired_securities_list_page__WEBPACK_IMPORTED_MODULE_7__["ExpiredSecuritiesListPage"]
      }];

      var ExpiredSecuritiesListPageModule = /*#__PURE__*/_createClass(function ExpiredSecuritiesListPageModule() {
        _classCallCheck(this, ExpiredSecuritiesListPageModule);
      });

      ExpiredSecuritiesListPageModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        imports: [src_app_commonSRC_shared_module__WEBPACK_IMPORTED_MODULE_6__["SharedModule"], src_app_commonSRC_psTemplates_ps_template_view_ps_template_view_template_module__WEBPACK_IMPORTED_MODULE_5__["PsTemplateViewModule"], _angular_router__WEBPACK_IMPORTED_MODULE_2__["RouterModule"].forChild(routes), src_app_commonSRC_psComponents_ps_components_module__WEBPACK_IMPORTED_MODULE_4__["PsComponentsModule"], src_app_commonBussinessSRC_psComponents_ps_container_lookup_option_ps_option_expired_security_ps_option_expired_security_component_module__WEBPACK_IMPORTED_MODULE_3__["PsOptionExpiredSecurityComponentModule"]],
        declarations: [_expired_securities_list_page__WEBPACK_IMPORTED_MODULE_7__["ExpiredSecuritiesListPage"]]
      })], ExpiredSecuritiesListPageModule);
      /***/
    }
  }]);
})();
//# sourceMappingURL=pages-expired-securities-list-expired-securities-list-module-es5.js.map