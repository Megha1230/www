(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([[52], {
    ...
    /***/
    function GpOE(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "OwnershipListPage", function () {
      ...
      var _raw_loader_ownership_list_page_html__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
      /*! raw-loader!./ownership-list.page.html */
      "Uv0E");
      /* harmony import */


      var _ownership_list_page_scss__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
      /*! ./ownership-list.page.scss */
      "4bBv");
      /* harmony import */
      ...
      var OwnershipListPage = /*#__PURE__*/function (_src_app_pages_omni_b) {
        function OwnershipListPage(commonProv, loggerP, omniPull, datepipe, navService) {
          var _this;

          _classCallCheck(this, OwnershipListPage);

          _this = _callSuper(this, OwnershipListPage);
          ...
          _this.ownersListOptions = {};
          _this.templateViewOptions = {
            group: _this.formGroup
          };
          _this.showOwnersList = false;
          _this.noOwnersFound = false;
          _this.noOwnersOptions = {
        ...
        _inherits(OwnershipListPage, _src_app_pages_omni_b);

        return _createClass(OwnershipListPage, [{
          key: "ngOnInit",
          value: function ngOnInit() {
            _superPropGet(OwnershipListPage, "init", this, 3)([]);
          ...
          value: function loadOwnersList() {
            ...
            this.omniPull.returnOwnerDetails(paramData).then(function (result) {
              if (result && result.gridModel.length > 0) {
                _this2.ownersListOptions.listOfOptions = _this2.populateOwners(result.gridModel);
              } else {
                _this2.noOwnersFound = true;
              }

              _this2.showOwnersList = true;
            })["catch"](function (error) {
              _this2.loggerP.error('Error: While fetching owners list :', error);
            });
          }
        }, {
          key: "populateOwners",
          value: function populateOwners(owners) {
            var ownerList = [];
            ...
            var _iterator = _createForOfIteratorHelper(owners),
                _step;
            ...
            try {
              for (_iterator.s(); !(_step = _iterator.n()).done;) {
                ...
                if (iterator && iterator.submitFieldValueMap) {
                  ...
                  ownerList.push(Object.assign(Object.assign({}, owner), {
                    title: owner.cifName + " - " + owner.cifNumber
                  }));
                }
              }
            } catch (err) {
          ...
          value: function ionViewWillEnter() {
            _superPropGet(OwnershipListPage, "viewWillEnter", this, 3)([]);
      ...
      OwnershipListPage.ctorParameters = function () {
        return [{
      ...
      OwnershipListPage = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_4__["Component"])({
    ...
    /***/
    function Uv0E(module, __webpack_exports__, __webpack_require__) {
      "use strict";
