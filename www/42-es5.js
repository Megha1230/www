(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([[42], {
    ...
    /***/
    function Qr3S(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "ExpiredSecuritiesListPage", function () {
        return ExpiredSecuritiesListPage;
      });
      /* harmony import */
      ...
      var _raw_loader_expired_securities_list_page_html__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
      /*! raw-loader!./expired-securities-list.page.html */
      "3z+t");
      /* harmony import */


      var _expired_securities_list_page_scss__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
      /*! ./expired-securities-list.page.scss */
      "kzgv");
      /* harmony import */
      ...
      var ExpiredSecuritiesListPage = /*#__PURE__*/function (_omni_base_omni_base_) {
        function ExpiredSecuritiesListPage(commonService, omniPull, navService) {
          var _this;

          _classCallCheck(this, ExpiredSecuritiesListPage);

          _this = _callSuper(this, ExpiredSecuritiesListPage);
          ...
          _this.psCurrency = new src_app_commonSRC_psPipes_ps_currency_ps_currency_pipe__WEBPACK_IMPORTED_MODULE_6__["PsCurrencyPipe"]();
          ...
          _this.prevFormat = 'DD/MM/YYYY';
          return _this;
        }

        _inherits(ExpiredSecuritiesListPage, _omni_base_omni_base_);

        return _createClass(ExpiredSecuritiesListPage, [{
          key: "ionViewWillEnter",
          value: function ionViewWillEnter() {
            _superPropGet(ExpiredSecuritiesListPage, "init", this, 3)([]);

            _superPropGet(ExpiredSecuritiesListPage, "viewWillEnter", this, 3)([]);
            ...
            var workingCif = this.commonService.session.getValueOf(src_app_commonSRC_psServices_models_common_constant__WEBPACK_IMPORTED_MODULE_8__["ConstantCommon"].WORKINGCIF);
            var securityListRequest = {};
            securityListRequest = {
              inRenewalPeriod: 'Y',
          ...
          key: "loadExpiredHoldingList",
          value: function loadExpiredHoldingList(securityListRequest) {
            return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, /*#__PURE__*/_regenerator().m(function _callee() {
              var _this2 = this;

              var result, _iterator, _step, security, eachSecurity;
              ...
              return _regenerator().w(function (_context) {
                while (1) switch (_context.n) {
                  case 0:
                    ...
                    _context.n = 1;
                    return this.omniPull.returnExpiredHoldingList(securityListRequest)["catch"](function (error) {
                      _this2.commonProv.logger.error('Error: While fetching returnExpiredHoldingList in expired securites page :', error);
                    });
      ...
      ExpiredSecuritiesListPage.ctorParameters = function () {
        return [{
      ...
      ExpiredSecuritiesListPage = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_3__["Component"])({
