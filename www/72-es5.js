(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([[72], {
    ...
    /***/
    function VfCj(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "PayeeManagePage", function () {
        return PayeeManagePage;
      });
      /* harmony import */
      ...
      var _raw_loader_payee_manage_page_html__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
      /*! raw-loader!./payee-manage.page.html */
      "iEmX");
      /* harmony import */
      ...
      var PayeeManagePage = /*#__PURE__*/function (_omni_base_omni_base_) {
        function PayeeManagePage(commonService, logger, navService, omniPull) {
          var _this;

          _classCallCheck(this, PayeeManagePage);

          _this = _callSuper(this, PayeeManagePage);
          _this.commonService = commonService;
          _this.logger = logger;
          _this.navService = navService;
          _this.omniPull = omniPull;
          _this.formGroup = new _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormGroup"]({});
          _this.payeeManagePageData = {};
          _this.showAddFavButton = true;
          _this.requestWasSent = true;
          _this.noPayeeFound = true;
        ...
        _inherits(PayeeManagePage, _omni_base_omni_base_);

        return _createClass(PayeeManagePage, [{
          key: "gotoAddFavPayeePage",
          value: function gotoAddFavPayeePage() {
            var page = {
          ...
          value: function ionViewDidEnter() {
            _superPropGet(PayeeManagePage, "init", this, 3)([]);

            _superPropGet(PayeeManagePage, "ionViewDidEnter", this, 3)([]);
          ...
          key: "populateFavPayeeList",
          value: function populateFavPayeeList(requestData) {
            return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, /*#__PURE__*/_regenerator().m(function _callee() {
              var _this2 = this;

              var result, populatedfavPayeeList, _iterator, _step, iterator, favPayee;
              ...
              return _regenerator().w(function (_context) {
                while (1) switch (_context.n) {
                  case 0:
                    ...
                    _context.n = 1;
                    return this.omniPull.returnFavPayee(requestData)["catch"](function (error) {
                      _this2.logger.error('Error: While fetching favPayee in favPayeeListPage :', error);
                    });

                  case 1:
                    result = _context.v;
                    populatedfavPayeeList = [];
      ...
      PayeeManagePage.ctorParameters = function () {
        return [{
    ...
    /***/
    function iEmX(module, __webpack_exports__, __webpack_require__) {
      "use strict";
