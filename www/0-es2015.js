...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "PsTemplateStepper", function() { return PsTemplateStepper; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "mrSG");
/* harmony import */ var _raw_loader_ps_template_stepper_template_html__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! raw-loader!./ps-template-stepper.template.html */ "pcow");
/* harmony import */ var _ps_template_stepper_template_scss__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./ps-template-stepper.template.scss */ "TsS6");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @angular/core */ "fXoL");
/* harmony import */ var src_app_commonBussinessSRC_psComponents_ps_drafts_report_ps_drafts_report_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! src/app/commonBussinessSRC/psComponents/ps-drafts-report/ps-drafts-report.component */ "Nt3t");
...
/* harmony import */ var _psComponents_ps_base_ps_base_action_ps_action_button_ps_button_next_ps_button_next_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../../psComponents/ps-base/ps-base-action/ps-action-button/ps-button-next/ps-button-next.component */ "WmIV");
/* harmony import */ var _psComponents_ps_base_ps_base_action_ps_action_button_ps_button_previous_ps_button_previous_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../../psComponents/ps-base/ps-base-action/ps-action-button/ps-button-previous/ps-button-previous.component */ "IDLg");
/* harmony import */ var _psComponents_ps_base_ps_base_action_ps_action_button_ps_button_submit_ps_button_submit_component__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../../psComponents/ps-base/ps-base-action/ps-action-button/ps-button-submit/ps-button-submit.component */ "OPJk");
/* harmony import */ var _psComponents_ps_base_ps_base_container_ps_container_stepper_ps_container_stepper_component__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../../psComponents/ps-base/ps-base-container/ps-container-stepper/ps-container-stepper.component */ "RoNR");
/* harmony import */ var _psServices_Event_event_service__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ../../psServices/Event/event.service */ "r40+");
/* harmony import */ var _psServices_models_common_constant__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ../../psServices/models/common-constant */ "zngb");
/* harmony import */ var _psServices_models_common_utils__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ../../psServices/models/common-utils */ "qEF5");
/* harmony import */ var _psServices_models_ps_app_settings__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ../../psServices/models/ps-app-settings */ "lE2x");
/* harmony import */ var _psServices_models_ps_common_settings__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ../../psServices/models/ps-common.settings */ "QZhd");
/* harmony import */ var _ps_template_base_ps_template_base_page__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ../ps-template-base/ps-template-base.page */ "uqA0");
...
let PsTemplateStepper = class PsTemplateStepper extends _ps_template_base_ps_template_base_page__WEBPACK_IMPORTED_MODULE_15__["PsTemplateBasePage"] {
    constructor(ref, events) {
        super();
        this.ref = ref;
        this.events = events;
        // eslint-disable-next-line @angular-eslint/no-output-on-prefix
        this.onNextPreviousStepper = new _angular_core__WEBPACK_IMPORTED_MODULE_3__["EventEmitter"]();
        this.draftLoaded = new _angular_core__WEBPACK_IMPORTED_MODULE_3__["EventEmitter"]();
        this.onTemplateStepWidgetOpen = new _angular_core__WEBPACK_IMPORTED_MODULE_3__["EventEmitter"]();
        this.onTemplateStepWidgetInit = new _angular_core__WEBPACK_IMPORTED_MODULE_3__["EventEmitter"]();
        this.isCheckerAndReportSelected = false;
        this.isMakerAndReportSelected = false;
        this.isDraft = false;
        this.stepperOptions = {};
        this.psContainerFlip = {
            hideVisibleArea: false,
            isFlipped: false
        };
        this.previousIconOptions = {
            iconName: 'arrow-round-back'
        };
        this.nextIconOptions = {
        ...
        this.saveAsDraftOptions = {
            labelKey: 'save_key',
            group: this.options.group
        };
        this.saveAsDraftWidgetOptions = {
    ...
    initJBPMFlow() {
        ...
        const newParams = _psServices_models_common_utils__WEBPACK_IMPORTED_MODULE_12__["CommonUtils"].createBPMParams(this.navParam.JBPM.screenMarkup.queryParams, null, this.commonProv.session, 'in');
    ...
    afterSubmitAction(response) {
        if (this.navParam.JBPM) {
            ...
            this.navParam.postCallFunction.func(Object.assign(Object.assign({}, this.navParam.JBPM), { bpmParametersMap: { amount_out: this.options.requestObject.transactionAmount } }));
        }
        else {
            ...
            if (response.dontShowReport !== 'true' && response.dontShowReport !== true) {
                if (((currentPageProfile === null || currentPageProfile === void 0 ? void 0 : currentPageProfile.PROG_REF) !== undefined && (response.outputType === 'S' || response.outputType === 'I')) || ((currentPageProfile === null || currentPageProfile === void 0 ? void 0 : currentPageProfile.FAILURE_PROG_REF) !== undefined && response.outputType === 'F')) {
                    let page = {
                        ...
                        param: Object.assign(Object.assign(Object.assign({}, this.options.requestObject), response.commonResponseList), { outputType: response.outputType, nextPage: this.options.nextPageOptions })
                    };
...
PsTemplateStepper.ctorParameters = () => [
...
PsTemplateStepper.propDecorators = {
    ...
    onNextPreviousStepper: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_3__["Output"] }],
    draftLoaded: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_3__["Output"] }],
    onTemplateStepWidgetOpen: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_3__["Output"] }],
    onTemplateStepWidgetInit: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_3__["Output"] }],
    next: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_3__["ViewChild"], args: ['next', { static: false },] }],
    previous: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_3__["ViewChild"], args: ['previous', { static: false },] }],
    submit: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_3__["ViewChild"], args: ['submit', { static: false },] }],
    report: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_3__["ViewChild"], args: ['report', { static: false },] }],
    containerStepper: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_3__["ViewChild"], args: ['containerStepper', { static: false },] }]
};
PsTemplateStepper = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    ...
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:paramtypes", [_angular_core__WEBPACK_IMPORTED_MODULE_3__["ChangeDetectorRef"], _psServices_Event_event_service__WEBPACK_IMPORTED_MODULE_10__["Events"]])
], PsTemplateStepper);
