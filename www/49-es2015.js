...
/* harmony import */ var _raw_loader_merchant_details_page_html__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! raw-loader!./merchant-details.page.html */ "R50q");
/* harmony import */ var _merchant_details_page_scss__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./merchant-details.page.scss */ "sLXS");
...
let MerchantDetailsPage = class MerchantDetailsPage extends _omni_base_omni_base_page__WEBPACK_IMPORTED_MODULE_10__["OmniBasePage"] {
    constructor(commonService, logger, navService, omniPull) {
        ...
        this.merchantInfoPanelOptions = {
            isExpandable: true,
            labelKey: 'merchant_details_key',
            expanded: true,
            iconName: 'contact'
        };
        this.merchantLocationPanelOptions = {
            isExpandable: true,
        ...
        this.merchantNameOptions = {
            fcName: 'cifName',
            labelKey: 'Jumia'
        };
        this.merchantImageOptions = {
    ...
    ngOnInit() {
        super.init();
        const paramList = this.navService.getAllParams() ? this.navService.getAllParams() : null;
        //api call with merchant name to get all needed merchant details
        //add the correct data for the above options 
    }
};
MerchantDetailsPage.ctorParameters = () => [
...
MerchantDetailsPage = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
