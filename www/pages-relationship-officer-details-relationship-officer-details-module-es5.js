(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["pages-relationship-officer-details-relationship-officer-details-module"], {
    /***/
    "2ery":
    /*!*****************************************************************************************************************************!*\
    ...
    "uRRQ":
    /*!*******************************************************************************************!*\
      !*** ./src/app/pages/relationship-officer-details/relationship-officer-details.module.ts ***!
      \*******************************************************************************************/

    /*! exports provided: RelationshipOfficerDetailsPageModule */
    ...
    function uRRQ(module, __webpack_exports__, __webpack_require__) {
      ...
      __webpack_require__.d(__webpack_exports__, "RelationshipOfficerDetailsPageModule", function () {
        return RelationshipOfficerDetailsPageModule;
      });
      /* harmony import */
      ...
      var src_app_commonSRC_psTemplates_ps_template_stepper_ps_template_stepper_template_module__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
      ...
      var _relationship_officer_details_page__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
      /*! ./relationship-officer-details.page */
      "dae6");

      var routes = [{
        path: '',
        component: _relationship_officer_details_page__WEBPACK_IMPORTED_MODULE_7__["RelationshipOfficerDetailsPage"]
      }];

      var RelationshipOfficerDetailsPageModule = /*#__PURE__*/_createClass(function RelationshipOfficerDetailsPageModule() {
        _classCallCheck(this, RelationshipOfficerDetailsPageModule);
      });

      RelationshipOfficerDetailsPageModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        imports: [src_app_commonSRC_shared_module__WEBPACK_IMPORTED_MODULE_6__["SharedModule"], src_app_commonSRC_psTemplates_ps_template_stepper_ps_template_stepper_template_module__WEBPACK_IMPORTED_MODULE_4__["PsTemplateStepperModule"], _angular_router__WEBPACK_IMPORTED_MODULE_2__["RouterModule"].forChild(routes), src_app_commonSRC_psComponents_ps_components_module__WEBPACK_IMPORTED_MODULE_3__["PsComponentsModule"], src_app_commonSRC_psTemplates_ps_template_view_ps_template_view_template_module__WEBPACK_IMPORTED_MODULE_5__["PsTemplateViewModule"]],
        declarations: [_relationship_officer_details_page__WEBPACK_IMPORTED_MODULE_7__["RelationshipOfficerDetailsPage"]],
        schemas: [_angular_core__WEBPACK_IMPORTED_MODULE_1__["CUSTOM_ELEMENTS_SCHEMA"]]
      })], RelationshipOfficerDetailsPageModule);
      /***/
    }
  }]);
})();
//# sourceMappingURL=pages-relationship-officer-details-relationship-officer-details-module-es5.js.map