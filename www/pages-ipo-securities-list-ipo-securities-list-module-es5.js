(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["pages-ipo-securities-list-ipo-securities-list-module"], {
    /***/
    "2ery":
    /*!*****************************************************************************************************************************!*\
    ...
    "F3eV":
    /*!*************************************************************************!*\
      !*** ./src/app/pages/ipo-securities-list/ipo-securities-list.module.ts ***!
      \*************************************************************************/

    /*! exports provided: IpoSecuritiesListPageModule */

    /***/
    function F3eV(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "IpoSecuritiesListPageModule", function () {
        return IpoSecuritiesListPageModule;
      });
      /* harmony import */
      ...
      var src_app_commonBussinessSRC_psComponents_ps_ipo_securities_list_ps_ipo_securities_list_component_module__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
      ...
      var _ipo_securities_list_page__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
      /*! ./ipo-securities-list.page */
      "T1ys");

      var routes = [{
        path: '',
        component: _ipo_securities_list_page__WEBPACK_IMPORTED_MODULE_7__["IpoSecuritiesListPage"]
      }];

      var IpoSecuritiesListPageModule = /*#__PURE__*/_createClass(function IpoSecuritiesListPageModule() {
        _classCallCheck(this, IpoSecuritiesListPageModule);
      });

      IpoSecuritiesListPageModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        imports: [src_app_commonSRC_shared_module__WEBPACK_IMPORTED_MODULE_6__["SharedModule"], src_app_commonSRC_psTemplates_ps_template_view_ps_template_view_template_module__WEBPACK_IMPORTED_MODULE_5__["PsTemplateViewModule"], src_app_commonBussinessSRC_psComponents_ps_ipo_securities_list_ps_ipo_securities_list_component_module__WEBPACK_IMPORTED_MODULE_3__["PsIpoSecuritiesListComponentModule"], _angular_router__WEBPACK_IMPORTED_MODULE_2__["RouterModule"].forChild(routes), src_app_commonSRC_psComponents_ps_components_module__WEBPACK_IMPORTED_MODULE_4__["PsComponentsModule"]],
        declarations: [_ipo_securities_list_page__WEBPACK_IMPORTED_MODULE_7__["IpoSecuritiesListPage"]]
      })], IpoSecuritiesListPageModule);
      /***/
    },
...
//# sourceMappingURL=pages-ipo-securities-list-ipo-securities-list-module-es5.js.map