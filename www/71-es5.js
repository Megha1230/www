(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([[71], {
    ...
    "MDb/":
    /*!*******************************************************************!*\
      !*** ./src/app/pages/mandates-approval/mandates-approval.page.ts ***!
      \*******************************************************************/

    /*! exports provided: MandatesApprovalPage */

    /***/
    function MDb_(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "MandatesApprovalPage", function () {
        return MandatesApprovalPage;
      });
      /* harmony import */
      ...
      var _raw_loader_mandates_approval_page_html__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
      /*! raw-loader!./mandates-approval.page.html */
      "QsU/");
      /* harmony import */


      var _omni_base_omni_base_page__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
      ...
      var MandatesApprovalPage = /*#__PURE__*/function (_omni_base_omni_base_) {
        function MandatesApprovalPage(logger, omniPull) {
          var _this;

          _classCallCheck(this, MandatesApprovalPage);

          _this = _callSuper(this, MandatesApprovalPage);
          _this.logger = logger;
          ...
          _this.noMandatesFound = false;
          _this.psDatePipe = new src_app_commonSRC_psPipes_ps_date_format_ps_date_format_pipe__WEBPACK_IMPORTED_MODULE_7__["PsDateFormatPipe"]();
          _this.psCurrency = new src_app_commonSRC_psPipes_ps_currency_ps_currency_pipe__WEBPACK_IMPORTED_MODULE_8__["PsCurrencyPipe"]();
          _this.noMandatesFoundOptions = {
            // create a key for mandates
        ...
        _inherits(MandatesApprovalPage, _omni_base_omni_base_);

        return _createClass(MandatesApprovalPage, [{
          key: "ngOnInit",
          value: function ngOnInit() {
            _superPropGet(MandatesApprovalPage, "init", this, 3)([]); // this.baseFormGroup = this.formGroup;


            this.mandatesListOptions = {
              isEditable: true
            };
            this.loadMandatesList();
          }
        }, {
          key: "loadMandatesList",
          value: function loadMandatesList() {
            var generalRequestData = {
              commonParametersList: {
                status: "A"
              }
            };
            this.returnMandates(generalRequestData);
          }
        }, {
          key: "returnMandates",
          value: function returnMandates(requestData) {
              ...
              return _regenerator().w(function (_context) {
                while (1) switch (_context.n) {
                  case 0:
                    ...
                    // const result = await this.omniPull.returnMandatesList(requestData).catch(error => {
                    //   this.logger.error('Error: While fetching mandates approvals  :', error);
                    // });
                    result = {
                      gridModel: [{
                        date: new Date(),
                        amount: "111",
                        frequency: "Monthly, 2 payments",
                        payIdType: "1234",
                        dateRange: new Date(),
                        benefName: "Beneficiary Name 1",
                        benefPhone: "01 23456" // valueDate?: string,

                      }, {
                        date: new Date(),
                        amount: "100",
                        frequency: "Monthly, 21 payments",
                        payIdType: "112233",
                        dateRange: new Date(),
                        benefName: "Beneficiary Name 2",
                        benefPhone: "01 24689" // valueDate?: string,

                      }]
                    };

                    if (result && result.gridModel.length > 0) {
                      this.mandatesListOptions.listOfOptions = this.populateMandatesApprovals(result.gridModel);
                    } else {
                      this.noMandatesFound = true;
                      this.mandatesListOptions.listOfOptions = [];
          ...
          key: "populateMandatesApprovals",
          value: function populateMandatesApprovals(mandateslist) {
            var mandatesApproval = [];

            var _iterator = _createForOfIteratorHelper(mandateslist),
                _step;
            ...
            try {
              for (_iterator.s(); !(_step = _iterator.n()).done;) {
                ...
                var mandates = {
                  ...
                  payIdType: iterator.payIdType,
                  // change the frequency formula
                  currencyBriefNameEnglish: iterator.currencyBriefNameEnglish,
                  frequency: iterator.frequency,
                  benefName: iterator.benefName,
                  currency: iterator.currency,
                  mandatesAmount: this.psCurrency.transform((iterator.amount || 0).toString(), 2) + ' (' + iterator.currencyBriefNameEnglish + ')',
                  dateRange: this.psDatePipe.transform(iterator.valueDate, 'DD/MM/YYYY').toString() + ' - ' + this.psDatePipe.transform(iterator.valueDate, 'DD/MM/YYYY').toString(),
                  benefPhone: iterator.benefPhone
                };
                mandatesApproval.push(mandates);
              }
            } catch (err) {
              _iterator.e(err);
            } finally {
            ...
            return mandatesApproval;
          }
        }]);
      }(_omni_base_omni_base_page__WEBPACK_IMPORTED_MODULE_2__["OmniBasePage"]);

      MandatesApprovalPage.ctorParameters = function () {
        return [{
      ...
      MandatesApprovalPage = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_3__["Component"])({
        selector: 'app-mandates-approval',
        template: _raw_loader_mandates_approval_page_html__WEBPACK_IMPORTED_MODULE_1__["default"]
      }), Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:paramtypes", [src_app_commonSRC_psServices_logger_logger_service__WEBPACK_IMPORTED_MODULE_5__["LoggerService"], src_app_commonBussinessSRC_psServices_omni_common_omni_pull_service__WEBPACK_IMPORTED_MODULE_6__["OmniPullService"]])], MandatesApprovalPage);
      /***/
    },
    ...
    "QsU/":
    /*!***********************************************************************************************************!*\
      !*** ./node_modules/raw-loader/dist/cjs.js!./src/app/pages/mandates-approval/mandates-approval.page.html ***!
      \***********************************************************************************************************/

    /*! exports provided: default */

    /***/
    function QsU_(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_exports__["default"] = "<ps-template-view [options]=\"templateViewOptions\">\n  <ps-mandates-list id=\"mandates-list\" [options]=\"mandatesListOptions\" (reloadFct)=\"loadMandatesList()\">\n  </ps-mandates-list>\n  <ps-label [options]=\"noMandatesFoundOptions\" *ngIf=\"noMandatesFound\" class=\"no-mandates-text\"></ps-label>\n</ps-template-view>";
      /***/
    },
