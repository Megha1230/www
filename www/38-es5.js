(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([[38], {
    ...
    "m0f4":
    /*!***************************************************************!*\
      !*** ./src/app/pages/cif-list-report/cif-list-report.page.ts ***!
      \***************************************************************/

    /*! exports provided: ReportCIFListPage */

    /***/
    function m0f4(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "ReportCIFListPage", function () {
        return ReportCIFListPage;
      });
      /* harmony import */
      ...
      var _raw_loader_cif_list_report_page_html__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
      /*! raw-loader!./cif-list-report.page.html */
      "rULr");
      /* harmony import */


      var _cif_list_report_page_scss__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
      /*! ./cif-list-report.page.scss */
      "yqP9");
      /* harmony import */
      ...
      var ReportCIFListPage = /*#__PURE__*/function (_omni_base_omni_base_) {
        function ReportCIFListPage(commonService, omniPull, navService) {
          var _this3;

          _classCallCheck(this, ReportCIFListPage);

          _this3 = _callSuper(this, ReportCIFListPage);
          ...
          _this3.templateViewOptions = {
            group: _this3.formGroup
          };
          _this3.psDatePipe = new src_app_commonSRC_psPipes_ps_date_format_ps_date_format_pipe__WEBPACK_IMPORTED_MODULE_6__["PsDateFormatPipe"]();
          _this3.requestWasSent = true;
          _this3.noRecordFoundOptions = {
            labelKey: "no_cif_openings_found_key",
            previewMode: false
          };
          _this3.noCifListFound = false;
          return _this3;
        }

        _inherits(ReportCIFListPage, _omni_base_omni_base_);

        return _createClass(ReportCIFListPage, [{
          key: "ionViewWillEnter",
          value: function ionViewWillEnter() {
            _superPropGet(ReportCIFListPage, "init", this, 3)([]);

            _superPropGet(ReportCIFListPage, "viewWillEnter", this, 3)([]);
          ...
          key: "loadCifOpeningList",
          value: function loadCifOpeningList() {
            return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, /*#__PURE__*/_regenerator().m(function _callee() {
              var _this4 = this;

              var populatedCifList, result, _iterator, _step, iterator, cifList;
                ...
                while (1) switch (_context.n) {
                  case 0:
                    ...
                    return this.omniPull.returnCIFList({})["catch"](function (error) {
                      _this4.commonProv.logger.error("Error: While fetching returnCIFList in cif-list-report page :", error);
                    });
                  ...
                  case 1:
                    ...
                    if (result && result.gridModel.length > 0) {
                      ...
                      try {
                        for (_iterator.s(); !(_step = _iterator.n()).done;) {
                          ...
                          cifList = {
                            ...
                            dateCreation: iterator.dateCreation ? this.psDatePipe.transform(iterator.dateCreation, src_app_commonSRC_psServices_models_common_constant__WEBPACK_IMPORTED_MODULE_7__["ConstantCommon"].PREV_DATE_FORMAT) : "--/--/----",
                            firstName: iterator.firstName ? iterator.firstName : "",
                            lastName: iterator.lastName ? iterator.lastName : "",
                            shortName: iterator.cifName ? iterator.cifName : "",
                            longName: iterator.longCifName ? iterator.longCifName : "",
                            motherFirstName: iterator.motherFirstName ? iterator.motherFirstName : "",
                            motherLastName: iterator.motherLastName ? iterator.motherLastName : "",
                      ...
                      this.omniPull.omniCommon.presentInfoAlert(this.omniPull.omniCommon.common.translate("no_cif_found_key"));
                    }
      ...
      ReportCIFListPage.ctorParameters = function () {
        return [{
      ...
      ReportCIFListPage = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_3__["Component"])({
        selector: "cif-list-report",
        template: _raw_loader_cif_list_report_page_html__WEBPACK_IMPORTED_MODULE_1__["default"],
        styles: [_cif_list_report_page_scss__WEBPACK_IMPORTED_MODULE_2__["default"]]
      }), Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:paramtypes", [src_app_commonSRC_psServices_ps_common_ps_common_service__WEBPACK_IMPORTED_MODULE_9__["PsCommonService"], src_app_commonBussinessSRC_psServices_omni_common_omni_pull_service__WEBPACK_IMPORTED_MODULE_5__["OmniPullService"], src_app_commonSRC_psServices_navigator_ps_navigator_service__WEBPACK_IMPORTED_MODULE_8__["PsNavigatorService"]])], ReportCIFListPage);
      /***/
    },
    ...
    "rULr":
    /*!*******************************************************************************************************!*\
      !*** ./node_modules/raw-loader/dist/cjs.js!./src/app/pages/cif-list-report/cif-list-report.page.html ***!
      \*******************************************************************************************************/

    /*! exports provided: default */

    /***/
    function rULr(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function yqP9(module, __webpack_exports__, __webpack_require__) {
      "use strict";
