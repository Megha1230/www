(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([[48], {
    ...
    /***/
    function R26h(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function T1ys(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "IpoSecuritiesListPage", function () {
        return IpoSecuritiesListPage;
      });
      /* harmony import */
      ...
      var _raw_loader_ipo_securities_list_page_html__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
      /*! raw-loader!./ipo-securities-list.page.html */
      "R26h");
      /* harmony import */


      var _ipo_securities_list_page_scss__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
      /*! ./ipo-securities-list.page.scss */
      "sRUq");
      /* harmony import */
      ...
      var IpoSecuritiesListPage = /*#__PURE__*/function (_omni_base_omni_base_) {
        function IpoSecuritiesListPage(commonService, logger, omniPull) {
          var _this;

          _classCallCheck(this, IpoSecuritiesListPage);

          _this = _callSuper(this, IpoSecuritiesListPage);
          _this.commonService = commonService;
          _this.logger = logger;
          _this.omniPull = omniPull;
          _this.ipoSecuritiesOptions = {};
          _this.formGroup = new _angular_forms__WEBPACK_IMPORTED_MODULE_4__["FormGroup"]({});
          _this.ipoSecuritiesList = [];
          ...
          _this.noIpoListFound = false;
          return _this;
        }

        _inherits(IpoSecuritiesListPage, _omni_base_omni_base_);

        return _createClass(IpoSecuritiesListPage, [{
          key: "ionViewWillEnter",
          value: function ionViewWillEnter() {
            _superPropGet(IpoSecuritiesListPage, "init", this, 3)([]);

            _superPropGet(IpoSecuritiesListPage, "viewWillEnter", this, 3)([]);
          ...
          key: "loadIpoSecurities",
          value: function loadIpoSecurities(paramData) {
          ...
          key: "returnIpoSecuritiesList",
          value: function returnIpoSecuritiesList(requestData) {
            return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, /*#__PURE__*/_regenerator().m(function _callee2() {
              ...
              return _regenerator().w(function (_context2) {
                while (1) switch (_context2.n) {
                  case 0:
                    _context2.n = 1;
                    return this.omniPull.returnIPOSecurities(requestData)["catch"](function (error) {
                      _this3.logger.error('Error: While fetching ipo scruities in IpoSecuritiesListPage :', error);
                    });
          ...
          key: "populateCustomIpoSecurities",
          value: function populateCustomIpoSecurities(ipoSecurities) {
            this.ipoSecuritiesList = [];

            var _iterator = _createForOfIteratorHelper(ipoSecurities),
                _step;
      ...
      IpoSecuritiesListPage.ctorParameters = function () {
        return [{
      ...
      IpoSecuritiesListPage = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_3__["Component"])({
