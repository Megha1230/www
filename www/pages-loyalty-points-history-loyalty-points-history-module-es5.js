(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["pages-loyalty-points-history-loyalty-points-history-module"], {
    /***/
    "2ery":
    /*!*****************************************************************************************************************************!*\
    ...
    "hFIs":
    /*!*******************************************************************************!*\
      !*** ./src/app/pages/loyalty-points-history/loyalty-points-history.module.ts ***!
      \*******************************************************************************/

    /*! exports provided: LoyaltyPointsHistoryPageModule */

    /***/
    function hFIs(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "LoyaltyPointsHistoryPageModule", function () {
        return LoyaltyPointsHistoryPageModule;
      });
      /* harmony import */
      ...
      var _loyalty_points_history_page__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
      /*! ./loyalty-points-history.page */
      "QoH7");

      var routes = [{
        path: '',
        component: _loyalty_points_history_page__WEBPACK_IMPORTED_MODULE_6__["LoyaltyPointsHistoryPage"]
      }];

      var LoyaltyPointsHistoryPageModule = /*#__PURE__*/_createClass(function LoyaltyPointsHistoryPageModule() {
        _classCallCheck(this, LoyaltyPointsHistoryPageModule);
      });

      LoyaltyPointsHistoryPageModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        imports: [src_app_commonSRC_shared_module__WEBPACK_IMPORTED_MODULE_5__["SharedModule"], _angular_router__WEBPACK_IMPORTED_MODULE_2__["RouterModule"].forChild(routes), src_app_commonSRC_psComponents_ps_components_module__WEBPACK_IMPORTED_MODULE_3__["PsComponentsModule"], src_app_commonSRC_psTemplates_ps_template_view_ps_template_view_template_module__WEBPACK_IMPORTED_MODULE_4__["PsTemplateViewModule"]],
        declarations: [_loyalty_points_history_page__WEBPACK_IMPORTED_MODULE_6__["LoyaltyPointsHistoryPage"]]
      })], LoyaltyPointsHistoryPageModule);
      /***/
    }
  }]);
})();
//# sourceMappingURL=pages-loyalty-points-history-loyalty-points-history-module-es5.js.map