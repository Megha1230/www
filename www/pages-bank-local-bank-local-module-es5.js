(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["pages-bank-local-bank-local-module"], {
    /***/
    "2eeL":
    /*!*******************************************************!*\
      !*** ./src/app/pages/bank-local/bank-local.module.ts ***!
      \*******************************************************/

    /*! exports provided: BankLocalPageModule */
    ...
    function eeL(module, __webpack_exports__, __webpack_require__) {
      ...
      __webpack_require__.d(__webpack_exports__, "BankLocalPageModule", function () {
        return BankLocalPageModule;
      });
      /* harmony import */
      ...
      var _bank_local_page__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
      /*! ./bank-local.page */
      "/Fll");

      var routes = [{
        path: '',
        component: _bank_local_page__WEBPACK_IMPORTED_MODULE_6__["BankLocalPage"]
      }];

      var BankLocalPageModule = /*#__PURE__*/_createClass(function BankLocalPageModule() {
        _classCallCheck(this, BankLocalPageModule);
      });

      BankLocalPageModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        ...
        declarations: [_bank_local_page__WEBPACK_IMPORTED_MODULE_6__["BankLocalPage"]],
...
//# sourceMappingURL=pages-bank-local-bank-local-module-es5.js.map