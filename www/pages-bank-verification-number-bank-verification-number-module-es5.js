(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["pages-bank-verification-number-bank-verification-number-module"], {
    /***/
    "gINX":
    /*!***********************************************************************************!*\
      !*** ./src/app/pages/bank-verification-number/bank-verification-number.module.ts ***!
      \***********************************************************************************/

    /*! exports provided: BankVerificationNumberPageModule */

    /***/
    function gINX(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "BankVerificationNumberPageModule", function () {
        return BankVerificationNumberPageModule;
      });
      /* harmony import */
      ...
      var _bank_verification_number_page__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
      /*! ./bank-verification-number.page */
      "psKI");

      var routes = [{
        path: '',
        component: _bank_verification_number_page__WEBPACK_IMPORTED_MODULE_6__["BankVerificationNumberPage"]
      }];

      var BankVerificationNumberPageModule = /*#__PURE__*/_createClass(function BankVerificationNumberPageModule() {
        _classCallCheck(this, BankVerificationNumberPageModule);
      });

      BankVerificationNumberPageModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        imports: [src_app_commonSRC_shared_module__WEBPACK_IMPORTED_MODULE_5__["SharedModule"], _angular_router__WEBPACK_IMPORTED_MODULE_2__["RouterModule"].forChild(routes), src_app_commonSRC_psComponents_ps_components_module__WEBPACK_IMPORTED_MODULE_3__["PsComponentsModule"], src_app_commonSRC_psTemplates_ps_template_form_ps_template_form_template_module__WEBPACK_IMPORTED_MODULE_4__["PsTemplateFormModule"]],
        declarations: [_bank_verification_number_page__WEBPACK_IMPORTED_MODULE_6__["BankVerificationNumberPage"]],
        schemas: [_angular_core__WEBPACK_IMPORTED_MODULE_1__["CUSTOM_ELEMENTS_SCHEMA"]]
      })], BankVerificationNumberPageModule);
      /***/
    },
...
//# sourceMappingURL=pages-bank-verification-number-bank-verification-number-module-es5.js.map