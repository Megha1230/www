(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["pages-prayer-time-prayer-time-module"], {
    /***/
    "2AJm":
    /*!*********************************************************!*\
      !*** ./src/app/pages/prayer-time/prayer-time.module.ts ***!
      \*********************************************************/

    /*! exports provided: PrayerTimePageModule */

    /***/
    function AJm(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "PrayerTimePageModule", function () {
      ...
      var _commonBussinessSRC_psComponents_ps_complex_components_ps_complex_prayer_time_ps_complex_prayer_time_component_module__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
      /*! ./../../commonBussinessSRC/psComponents/ps-complex-components/ps-complex-prayer-time/ps-complex-prayer-time.component.module */
      "TloJ");
      /* harmony import */


      var _commonSRC_psTemplates_ps_template_view_ps_template_view_template_module__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
      /*! ./../../commonSRC/psTemplates/ps-template-view/ps-template-view.template.module */
      "FQ9l");
      /* harmony import */


      var _prayer_time_page__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
      /*! ./prayer-time.page */
      "dFaZ");

      var routes = [{
        path: '',
        component: _prayer_time_page__WEBPACK_IMPORTED_MODULE_6__["PrayerTimePage"]
      }];

      var PrayerTimePageModule = /*#__PURE__*/_createClass(function PrayerTimePageModule() {
        _classCallCheck(this, PrayerTimePageModule);
      });

      PrayerTimePageModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        imports: [src_app_commonSRC_shared_module__WEBPACK_IMPORTED_MODULE_3__["SharedModule"], _angular_router__WEBPACK_IMPORTED_MODULE_2__["RouterModule"].forChild(routes), _commonBussinessSRC_psComponents_ps_complex_components_ps_complex_prayer_time_ps_complex_prayer_time_component_module__WEBPACK_IMPORTED_MODULE_4__["PsComplexPrayerTimeModule"], _commonSRC_psTemplates_ps_template_view_ps_template_view_template_module__WEBPACK_IMPORTED_MODULE_5__["PsTemplateViewModule"]],
        declarations: [_prayer_time_page__WEBPACK_IMPORTED_MODULE_6__["PrayerTimePage"]]
...
//# sourceMappingURL=pages-prayer-time-prayer-time-module-es5.js.map