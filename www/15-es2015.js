...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "PsComplexCifAccountComponent", function() { return PsComplexCifAccountComponent; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "mrSG");
/* harmony import */ var _raw_loader_ps_complex_cif_account_component_html__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! raw-loader!./ps-complex-cif-account.component.html */ "/G9Y");
/* harmony import */ var _ps_complex_cif_account_component_scss__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./ps-complex-cif-account.component.scss */ "lG59");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @angular/core */ "fXoL");
/* harmony import */ var src_app_commonSRC_psServices_ps_common_ps_common_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! src/app/commonSRC/psServices/ps-common/ps-common.service */ "Q0Ba");
...
/* harmony import */ var src_app_commonSRC_psServices_models_common_utils__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! src/app/commonSRC/psServices/models/common-utils */ "qEF5");
...
let PsComplexCifAccountComponent = class PsComplexCifAccountComponent extends src_app_commonSRC_psComponents_ps_base_ps_base_field_ps_base_field_component__WEBPACK_IMPORTED_MODULE_6__["PsBaseFieldComponent"] {
    constructor(commonService, logger, omniPull) {
        super(commonService, logger);
        this.omniPull = omniPull;
        this.cifValidated = new _angular_core__WEBPACK_IMPORTED_MODULE_3__["EventEmitter"]();
    ...
    onCifChange(value) {
        ...
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            const cifNumber = this.options.group.controls[this.cifNumberOptions.fcName].value;
            if (!cifNumber) {
                src_app_commonSRC_psServices_models_common_utils__WEBPACK_IMPORTED_MODULE_8__["CommonUtils"].presentFailureAlert(this.commonProv.translate('enter_value_before_proceed_key'), { autoHide: true });
                return;
            }
            const requestData = {
            ...
            try {
                const result = yield this.omniPull.returnCIFDetails(requestData);
                const cifDetails = (_b = (_a = result.data.result) === null || _a === void 0 ? void 0 : _a[0]) === null || _b === void 0 ? void 0 : _b.cifDetails;
...
PsComplexCifAccountComponent.ctorParameters = () => [
...
PsComplexCifAccountComponent.propDecorators = {
    ...
    cifValidated: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_3__["Output"] }]
};
PsComplexCifAccountComponent = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    ...
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:paramtypes", [src_app_commonSRC_psServices_ps_common_ps_common_service__WEBPACK_IMPORTED_MODULE_4__["PsCommonService"],
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("<ps-input-numeric id=\"'userCifNo' + id\" [options]=\"cifNumberOptions\" (onPsChange)=\"onCifChange($event)\"></ps-input-numeric>\n\n");
...
/* harmony import */ var src_app_commonBussinessSRC_psComponents_ps_beneficiary_ps_cash_transfer_ps_cash_transfer_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! src/app/commonBussinessSRC/psComponents/ps-beneficiary/ps-cash-transfer/ps-cash-transfer.component */ "YaLh");
/* harmony import */ var src_app_commonBussinessSRC_psComponents_ps_beneficiary_ps_local_beneficiary_ps_local_beneficiary_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! src/app/commonBussinessSRC/psComponents/ps-beneficiary/ps-local-beneficiary/ps-local-beneficiary.component */ "jXvJ");
/* harmony import */ var src_app_commonBussinessSRC_psComponents_ps_complex_components_ps_complex_exchange_ps_complex_exchange_component__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! src/app/commonBussinessSRC/psComponents/ps-complex-components/ps-complex-exchange/ps-complex-exchange.component */ "/M2N");
/* harmony import */ var src_app_commonBussinessSRC_psComponents_ps_keyin_input_ps_input_account_number_ps_input_account_number_component__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! src/app/commonBussinessSRC/psComponents/ps-keyin-input/ps-input-account-number/ps-input-account-number.component */ "UTjL");
/* harmony import */ var src_app_commonBussinessSRC_psComponents_ps_swift_account_list_ps_swift_account_list_component__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! src/app/commonBussinessSRC/psComponents/ps-swift-account-list/ps-swift-account-list.component */ "yh/l");
/* harmony import */ var src_app_commonBussinessSRC_psServices_models_ps_common_bussiness_constant__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! src/app/commonBussinessSRC/psServices/models/ps-common-bussiness-constant */ "V0Fi");
/* harmony import */ var src_app_commonBussinessSRC_psServices_models_ps_common_bussiness_interfaces__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! src/app/commonBussinessSRC/psServices/models/ps-common-bussiness-interfaces */ "Nnln");
/* harmony import */ var src_app_commonBussinessSRC_psServices_models_ps_commonBusiness_settings__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! src/app/commonBussinessSRC/psServices/models/ps-commonBusiness.settings */ "fOh1");
/* harmony import */ var src_app_commonSRC_psServices_logger_logger_service__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! src/app/commonSRC/psServices/logger/logger.service */ "DFXC");
/* harmony import */ var src_app_commonSRC_psServices_models_common_constant__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! src/app/commonSRC/psServices/models/common-constant */ "zngb");
/* harmony import */ var src_app_commonSRC_psServices_models_common_utils__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! src/app/commonSRC/psServices/models/common-utils */ "qEF5");
/* harmony import */ var src_app_commonSRC_psServices_models_ps_common_settings__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! src/app/commonSRC/psServices/models/ps-common.settings */ "QZhd");
/* harmony import */ var src_app_commonSRC_psServices_navigator_ps_navigator_service__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(/*! src/app/commonSRC/psServices/navigator/ps-navigator.service */ "woXy");
/* harmony import */ var src_app_commonSRC_psServices_ps_common_ps_common_service__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(/*! src/app/commonSRC/psServices/ps-common/ps-common.service */ "Q0Ba");
/* harmony import */ var _commonBussinessSRC_psComponents_ps_beneficiary_ps_internal_beneficiary_ps_internal_beneficiary_component__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(/*! ../../commonBussinessSRC/psComponents/ps-beneficiary/ps-internal-beneficiary/ps-internal-beneficiary.component */ "Zrkw");
/* harmony import */ var _commonBussinessSRC_psComponents_ps_beneficiary_ps_international_beneficiary_ps_international_beneficiary_component__WEBPACK_IMPORTED_MODULE_21__ = __webpack_require__(/*! ../../commonBussinessSRC/psComponents/ps-beneficiary/ps-international-beneficiary/ps-international-beneficiary.component */ "ZI0R");
/* harmony import */ var _omni_base_omni_base_page__WEBPACK_IMPORTED_MODULE_22__ = __webpack_require__(/*! ../omni-base/omni-base.page */ "gKqT");
/* harmony import */ var _commonBussinessSRC_psServices_omni_common_omni_pull_service__WEBPACK_IMPORTED_MODULE_23__ = __webpack_require__(/*! ./../../commonBussinessSRC/psServices/omni-common/omni-pull.service */ "ZyuK");
/* harmony import */ var src_app_commonBussinessSRC_psComponents_ps_complex_cif_account_ps_complex_cif_account_component__WEBPACK_IMPORTED_MODULE_24__ = __webpack_require__(/*! src/app/commonBussinessSRC/psComponents/ps-complex-cif-account/ps-complex-cif-account.component */ "+R6y");
...
let PaymentPage = class PaymentPage extends _omni_base_omni_base_page__WEBPACK_IMPORTED_MODULE_22__["OmniBasePage"] {
    constructor(commonProvider, logger, nav, omniPull) {
        var _a, _b;
        super();
        ...
        this.ownAccountVO = {};
        this.toBeneficiarySegment = 'to_benef';
        this.showPurpposeSubPurpose = false;
        this.fromMultiLoader = false;
        this.isCifValidated = false;
        this.step2Name = "payment_step2";
        this.defaultSegment = {};
        this.stepperOptions = {
        ...
        this.toBenefPanelOptions = {
            isExpandable: false,
            labelKey: 'to_beneficiary_transfer_details_key',
            iconName: 'crop',
            expanded: true
        };
        this.toOtherPanelOptions = {
            isExpandable: false,
        ...
        this.localBeneficiariesOptions = {
        ...
        this.internalBeneficiariesOptions = {
            labelKey: 'to_beneficiary_key',
            placeHolder: 'select_to_beneficiary_key',
        ...
        this.internationalBeneficiariesOptions = {
            labelKey: '',
            placeHolder: 'select_to_beneficiary_key',
        ...
        this.bankCardBeneficiariesOptions = {
        ...
        this.localCardBeneficiariesOptions = {
            labelKey: 'to_beneficiary_key',
            placeHolder: 'select_to_beneficiary_key',
            component: src_app_commonBussinessSRC_psComponents_ps_beneficiary_ps_local_beneficiary_ps_local_beneficiary_component__WEBPACK_IMPORTED_MODULE_7__["PsLocalBeneficiaryComponent"],
            group: this.formGroup,
        ...
        this.LocalTransfersBeneficiary = false;
        this.LocalTransfersNonBeneficiary = false;
        this.EnableLocalBeneficiaryApproval = false;
        // international Transfers params
        this.internationTransfersBeneficiary = false;
        this.internationTransfersNonBeneficiary = false;
        this.enableInternationBeneficiaryApproval = false;
        // transfer Between Bank Accounts params
        this.transferBetweenBankAccountsBeneficiary = false;
        this.transferBetweenBankAccountsNonBeneficiary = false;
        // scheduled Local Transfer params
        this.scheduledLocalTransferBeneficiary = false;
        this.scheduledLocalTransferNonBeneficiary = false;
        // scheduled International Transfer params
        this.scheduledInternationalTransferBeneficiary = false;
        this.scheduledInternationalTransferNonBeneficiary = false;
    ...
    ngOnInit() {
        ...
        const userInformation = this.commonProv.session.getValueOf(src_app_commonSRC_psServices_models_common_constant__WEBPACK_IMPORTED_MODULE_15__["ConstantCommon"].USERINFO);
        const paymentSec = userInformation === null || userInformation === void 0 ? void 0 : userInformation.businessProfiles.find((i) => i.operVO.OPER_ID === src_app_commonBussinessSRC_psServices_models_ps_common_bussiness_constant__WEBPACK_IMPORTED_MODULE_11__["CommonBussinessConstant"].PAYMENT_SEC_OPER_ID);
        try {
            ...
            if (paymentSec) {
                this.toOtherAccountNumberOptions.showScannerIcon =
                    src_app_commonSRC_psServices_models_ps_common_settings__WEBPACK_IMPORTED_MODULE_17__["PsCommonSettings"].oper_ID !== src_app_commonBussinessSRC_psServices_models_ps_common_bussiness_constant__WEBPACK_IMPORTED_MODULE_11__["CommonBussinessConstant"].QR_PAYMENT_OPER_ID &&
                        ((_b = this.nav.getAllParams()) === null || _b === void 0 ? void 0 : _b.from) !== 'MR' && ((_c = paymentSec.children) === null || _c === void 0 ? void 0 : _c.some(c => c.operVO.OPER_ID === src_app_commonBussinessSRC_psServices_models_ps_common_bussiness_constant__WEBPACK_IMPORTED_MODULE_11__["CommonBussinessConstant"].QR_PAYMENT_OPER_ID));
            }
        }
        catch (error) {
        ...
        if (this.fromMultiLoader) { // Added to cater for the multi outlet multi transfers by Ammar
        ...
        let operCustomization = this.commonProvider.returnOperCustomization();
    ...
    ngAfterViewInit() {
        var _a;
        const screenVO = (_a = this.nav.getAllParams()) === null || _a === void 0 ? void 0 : _a.ScreenVO;
        if (screenVO) {
    ...
    ionViewDidEnter() {
        ...
        this.commonProv.applyDynScreenDisplay(src_app_commonSRC_psServices_models_common_constant__WEBPACK_IMPORTED_MODULE_15__["ConstantCommon"].ACTION_TYPE_VISIBLE, [this.banksOptions.subCategoryFcName], 0);
        //Added by ghada for tp #1261037 for fixing not able to proceed to the next step issue and toAmount not being readonly
        ...
        this.commonProv.applyDynScreenDisplay(src_app_commonSRC_psServices_models_common_constant__WEBPACK_IMPORTED_MODULE_15__["ConstantCommon"].ACTION_TYPE_READONLY, [this.complexExchangeOptions.fromAmountOptions.currenciesOptions.fcName,
    ...
    onFromAccountChange(fromAccount) {
        ...
        //if own account transfer removce selected account from to account
     ...
     */
    internalBeneficiaryChange(internalBeneficiary) {
        if (this.ownAccountVO[this.complexExchangeOptions.fromAmountOptions.currenciesOptions.fcName]) {
            const validationRequest = {
                fromCurrency: +(this.ownAccountVO[this.complexExchangeOptions.fromAmountOptions.currenciesOptions.fcName].itemValue ? this.ownAccountVO[this.complexExchangeOptions.fromAmountOptions.currenciesOptions.fcName].itemValue : this.ownAccountVO[this.complexExchangeOptions.fromAmountOptions.currenciesOptions.fcName]),
                toCurrency: +internalBeneficiary.currency,
                listOfAffectedFields: [
                    this.complexExchangeOptions.fromAmountOptions.currenciesOptions.fcName,
                    this.internalBeneficiariesOptions.fcName,
        ...
        if (internalBeneficiary !== undefined) {
            this.accountNumber = internalBeneficiary.accountNumber,
                this.complexExchangeOptions.toAmountOptions.currencyCode = internalBeneficiary.currency;
     ...
     */
    localBeneficiaryChange(localBeneficiary) {
     ...
     */
    internationalBeneficiaryChange(internationalBeneficiary) {
    ...
    cashBeneficiaryChange(cashBeneficiary) {
    }
    localCardBeneficiaryChange(localCardBeneficiary) {
    ...
    bankCardBeneficiaryChange(bankCardBeneficiary) {
        if (this.ownAccountVO[this.complexExchangeOptions.fromAmountOptions.currenciesOptions.fcName] && bankCardBeneficiary.currency) {
            const validationRequest = {
                ...
                listOfAffectedFields: [
                    this.complexExchangeOptions.fromAmountOptions.currenciesOptions.fcName,
                    this.bankCardBeneficiariesOptions.fcName,
                    this.complexExchangeOptions.toAmountOptions.currenciesOptions.fcName
                ],
                screenVO: this.ownAccountVO,
                listOfAccounts: [this.fromAccountRef, this.exchangeRef]
    ...
    enableRemittanceTransfer() {
        if (src_app_commonSRC_psServices_models_ps_common_settings__WEBPACK_IMPORTED_MODULE_17__["PsCommonSettings"].oper_ID === src_app_commonBussinessSRC_psServices_models_ps_common_bussiness_constant__WEBPACK_IMPORTED_MODULE_11__["CommonBussinessConstant"].INTRA_BANK_REMITTANCE_TRANSFER ||
            src_app_commonSRC_psServices_models_ps_common_settings__WEBPACK_IMPORTED_MODULE_17__["PsCommonSettings"].oper_ID === src_app_commonBussinessSRC_psServices_models_ps_common_bussiness_constant__WEBPACK_IMPORTED_MODULE_11__["CommonBussinessConstant"].LOCAL_REMITTANCE_TRANSFER ||
            src_app_commonSRC_psServices_models_ps_common_settings__WEBPACK_IMPORTED_MODULE_17__["PsCommonSettings"].oper_ID === src_app_commonBussinessSRC_psServices_models_ps_common_bussiness_constant__WEBPACK_IMPORTED_MODULE_11__["CommonBussinessConstant"].INTERNATIONAL_REMITTANCE_TRANSFER) {
    ...
    enableCashBeneficiary() {
        return this.toAccountComponent.toAccountType === 'cashTransfer' || src_app_commonSRC_psServices_models_ps_common_settings__WEBPACK_IMPORTED_MODULE_17__["PsCommonSettings"].oper_ID == src_app_commonBussinessSRC_psServices_models_ps_common_bussiness_constant__WEBPACK_IMPORTED_MODULE_11__["CommonBussinessConstant"].CASH_TRANSFER_OPER_ID
            || src_app_commonSRC_psServices_models_ps_common_settings__WEBPACK_IMPORTED_MODULE_17__["PsCommonSettings"].oper_ID == src_app_commonBussinessSRC_psServices_models_ps_common_bussiness_constant__WEBPACK_IMPORTED_MODULE_11__["CommonBussinessConstant"].STOP_CASH_TRANSFER_OPER_ID;
    }
    enableBankCardBeneficiary() {
        return this.toAccountComponent.toAccountType === 'bankCardSettlement';
    }
    enableLocalCardBeneficiary() {
    ...
    resetSegmentData(selectedSegment) {
        var _a, _b;
        if (selectedSegment === this.toBeneficiarySegment) {
            ...
            if (this.enableLocalBeneficiary()) {
                ...
                this.resetComponentVal([this.swiftCodeOptions.fcName, this.benefCurrencyOptions.fcName]);
                //AIBIRQI250064 clone from Makki: PBSDB240042 - Adding fields on the International Transfer screen
            ...
            if (this.enableLocalBeneficiary())
                this.localBeneficiaryLookupComponentObj.reset();
            else if (this.enableInternationalBeneficiary())
                this.internationalBeneficiaryLookupComponentObj.reset();
            else if (this.enableInternalBeneficiary())
                this.internalBeneficiaryLookupComponentObj.reset();
            else if (this.enableLocalCardBeneficiary())
                this.localCardBeneficiaryLookupComponentObj.reset();
            else
                (this.enableBankCardBeneficiary());
            this.bankCardBeneficiaryLookupComponentObj.reset();
        }
    }
    onEmptyAccountNumb(event) {
    ...
    onAccountNumbChanged(event) {
        ...
        //Added by ghada tp#1266566 for fixing the issue of accountnumber being removed on clicking next and benefName not being send in navParams on navigate
    ...
    callCurrencyCombinationValidateService(validationRequestParam) {
        var _a, _b;
        if (!validationRequestParam) {
            const validationRequest = {
                ...
                listOfAffectedFields: [this.toOtherAccountNumberOptions.fcName,
                    this.complexExchangeOptions.fromAmountOptions.currenciesOptions.fcName,
                    this.complexExchangeOptions.toAmountOptions.currenciesOptions.fcName],
                screenVO: this.ownAccountVO,
        ...
        if (validationRequestParam.fromCurrency && validationRequestParam.toCurrency) {
            this.omniPull.validateCurrencyCombination(validationRequestParam).then(result => {
                if (!result) {
                    if (this.showToOtherDetails) {
                        this.resetComponentVal([this.benefCurrencyOptions.fcName, this.beneficiaryOptions.fcName]);
                    }
                }
    ...
    onBenefCurrencyChanged(currency) {
        if (currency !== undefined) {
            if (!this.enableInternalBeneficiary()) { //IMAL-7934, added by ghada for stop calling CurrencyCombination service more tham one with the same request in case internal transfer where the it will be called on accountNumber change which responsible for setting the benefCurrency 
                this.callCurrencyCombinationValidateService();
            }
    ...
    purposeOnCurrencyChange() {
        if (this.complexExchangeOptions.fromAmountOptions.currencyCode !== undefined && this.complexExchangeOptions.toAmountOptions.currencyCode !== undefined) {
            ...
            if (this.commonProv.getLKCompany().isLK && this.complexExchangeOptions.fromAmountOptions.currencyCode !== this.complexExchangeOptions.toAmountOptions.currencyCode && this.complexExchangeOptions.toAmountOptions.currencyCode == this.commonProv.getLKCompany().currencyCode) {
                ...
                this.commonProv.applyDynScreenDisplay(src_app_commonSRC_psServices_models_common_constant__WEBPACK_IMPORTED_MODULE_15__["ConstantCommon"].ACTION_TYPE_MANDATORY, [this.purposeOptionsDDLB.subCategoryFcName], 1);
                ...
                this.showPurpposeSubPurpose = false;
                this.commonProv.applyDynScreenDisplay(src_app_commonSRC_psServices_models_common_constant__WEBPACK_IMPORTED_MODULE_15__["ConstantCommon"].ACTION_TYPE_MANDATORY, [this.purposeOptionsDDLB.categoryFcName], 0);
                ...
                this.commonProv.applyDynScreenDisplay(src_app_commonSRC_psServices_models_common_constant__WEBPACK_IMPORTED_MODULE_15__["ConstantCommon"].ACTION_TYPE_MANDATORY, [this.purposeOptionsDDLB.subCategoryFcName], 0);
    ...
    updateAccountVO(params) {
        ...
        const accountNumberControlVal = this.formGroup.controls[this.toOtherAccountNumberOptions.fcName] ? this.formGroup.controls[this.toOtherAccountNumberOptions.fcName].value : null;
        ...
        if (this.accountNumber) {
            if (this.enableInternalBeneficiary()) {
                if (!this.ownAccountVO['toAccount'] && src_app_commonSRC_psServices_models_common_utils__WEBPACK_IMPORTED_MODULE_16__["CommonUtils"].isNotObject(this.ownAccountVO['toAccount'])) { //construct a toAccont object to be sent in the request in the case of "to other" transfer scenario similar to the object costructed in the "to benef. " transfer scaenrio for the submit service 
    ...
    onCifValidated(event) {
        if (event.cifStatus === src_app_commonBussinessSRC_psServices_models_ps_common_bussiness_constant__WEBPACK_IMPORTED_MODULE_11__["CommonBussinessConstant"].ACTIVE_CIF_STATUS) {
            ...
            setTimeout(() => {
                var _a;
                (_a = this.toCifAccountObj) === null || _a === void 0 ? void 0 : _a.loadAccounts();
            }, 0);
        }
        else {
    ...
    onCifAccountSelected(selectedAccount) {
        if (selectedAccount) {
            const accountName = selectedAccount.accountTypeDesc;
    ...
    deleteNullPropsFromVO() {
        for (const fcName in this.ownAccountVO) {
    ...
    resetComponentVal(componentFcNamesList) {
        for (const component of componentFcNamesList) {
...
PaymentPage.propDecorators = {
    exchangeChild: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_3__["ViewChild"], args: [src_app_commonBussinessSRC_psComponents_ps_complex_components_ps_complex_exchange_ps_complex_exchange_component__WEBPACK_IMPORTED_MODULE_8__["PsComplexExchangeComponent"],] }],
    accountNb: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_3__["ViewChild"], args: ['accountNb',] }],
    cifAccount: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_3__["ViewChild"], args: [src_app_commonBussinessSRC_psComponents_ps_complex_cif_account_ps_complex_cif_account_component__WEBPACK_IMPORTED_MODULE_24__["PsComplexCifAccountComponent"],] }],
    ...
    toCifAccountObj: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_3__["ViewChild"], args: ['toCifAccountObj',] }],
    exchangeRef: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_3__["ViewChild"], args: ['exchangeRef',] }],
    localBeneficiaryLookupComponentObj: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_3__["ViewChild"], args: ['localBeneficiaryLookupComponentObj',] }],
    internalBeneficiaryLookupComponentObj: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_3__["ViewChild"], args: ['internalBeneficiaryLookupComponentObj',] }],
    internationalBeneficiaryLookupComponentObj: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_3__["ViewChild"], args: ['internationalBeneficiaryLookupComponentObj',] }],
    bankCardBeneficiaryLookupComponentObj: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_3__["ViewChild"], args: ['bankCardBeneficiaryLookupComponentObj',] }],
    localCardBeneficiaryLookupComponentObj: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_3__["ViewChild"], args: ['localCardBeneficiaryLookupComponentObj',] }]
};
PaymentPage = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    ...
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:paramtypes", [src_app_commonSRC_psServices_ps_common_ps_common_service__WEBPACK_IMPORTED_MODULE_19__["PsCommonService"],
        src_app_commonSRC_psServices_logger_logger_service__WEBPACK_IMPORTED_MODULE_14__["LoggerService"],
        src_app_commonSRC_psServices_navigator_ps_navigator_service__WEBPACK_IMPORTED_MODULE_18__["PsNavigatorService"],
        _commonBussinessSRC_psServices_omni_common_omni_pull_service__WEBPACK_IMPORTED_MODULE_23__["OmniPullService"]])
], PaymentPage);
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "PsSwiftAccountListComponent", function() { return PsSwiftAccountListComponent; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "mrSG");
/* harmony import */ var _raw_loader_ps_swift_account_list_component_html__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! raw-loader!./ps-swift-account-list.component.html */ "4Hic");
/* harmony import */ var _ps_swift_account_list_component_scss__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./ps-swift-account-list.component.scss */ "Q4uH");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @angular/core */ "fXoL");
...
/* harmony import */ var _commonSRC_psServices_ps_common_ps_common_service__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../../../commonSRC/psServices/ps-common/ps-common.service */ "Q0Ba");
 ...
 */
let PsSwiftAccountListComponent = class PsSwiftAccountListComponent extends _commonSRC_psComponents_ps_base_ps_base_field_ps_base_field_component__WEBPACK_IMPORTED_MODULE_4__["PsBaseFieldComponent"] {
    constructor(commonServices, logger, cdRef) {
...
PsSwiftAccountListComponent.ctorParameters = () => [
...
PsSwiftAccountListComponent = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_3__["Component"])({
    ...
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:paramtypes", [_commonSRC_psServices_ps_common_ps_common_service__WEBPACK_IMPORTED_MODULE_6__["PsCommonService"],
        _commonSRC_psServices_logger_logger_service__WEBPACK_IMPORTED_MODULE_5__["LoggerService"],
        _angular_core__WEBPACK_IMPORTED_MODULE_3__["ChangeDetectorRef"]])
], PsSwiftAccountListComponent);
