(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([[63], {
    ...
    /***/
    function LYUq(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function imev(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function lAGo(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      var UsersListPage = /*#__PURE__*/function (_omni_base_omni_base_) {
        function UsersListPage(commonService, logger, navService, omniPull) {
          var _this3;

          _classCallCheck(this, UsersListPage);

          _this3 = _callSuper(this, UsersListPage);
          ...
          _this3.showCreateUserButton = false;
        ...
        _inherits(UsersListPage, _omni_base_omni_base_);

        return _createClass(UsersListPage, [{
          key: "ionViewWillEnter",
          value: function ionViewWillEnter() {
            _superPropGet(UsersListPage, "init", this, 3)([]);

            this.baseFormGroup = this.formGroup; // Added by Zunair For #BUG 1257538

            _superPropGet(UsersListPage, "viewWillEnter", this, 3)([]);
          ...
          key: "populateUsersList",
          value: function populateUsersList() {
            var _a;

            return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, /*#__PURE__*/_regenerator().m(function _callee() {
              var _this4 = this;

              var result, populatedUsersList, _iterator, _step, iterator, userList;
              ...
              return _regenerator().w(function (_context) {
                while (1) switch (_context.n) {
                  case 0:
                    ...
                    _context.n = 1;
                    return this.omniPull.fetchUserAccountsList()["catch"](function (error) {
                      _this4.logger.error('Error: While fetching accounts in UsersListPage :', error);
                    });
          ...
          key: "accountsMapping",
          value: function accountsMapping(allowedAccounts) {
            var acc = " ";
            allowedAccounts.forEach(function (element) {
