(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["pages-demand-draft-demand-draft-module"], {
    /***/
    "HbOp":
    /*!*******************************************************************************************************!*\
    ...
    "nnrt":
    /*!***********************************************************!*\
      !*** ./src/app/pages/demand-draft/demand-draft.module.ts ***!
      \***********************************************************/

    /*! exports provided: DemandDraftPageModule */

    /***/
    function nnrt(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "DemandDraftPageModule", function () {
        return DemandDraftPageModule;
      });
      /* harmony import */
      ...
      var src_app_commonBussinessSRC_psComponents_ps_select_dropdown_ps_dropdown_currencies_ps_dropdown_currencies_component_module__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
      ...
      var _demand_draft_page__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(
      /*! ./demand-draft.page */
      "D2qA");

      var routes = [{
        path: '',
        component: _demand_draft_page__WEBPACK_IMPORTED_MODULE_10__["DemandDraftPage"]
      }];

      var DemandDraftPageModule = /*#__PURE__*/_createClass(function DemandDraftPageModule() {
        _classCallCheck(this, DemandDraftPageModule);
      });

      DemandDraftPageModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        imports: [src_app_commonSRC_shared_module__WEBPACK_IMPORTED_MODULE_9__["SharedModule"], src_app_commonSRC_psTemplates_ps_template_stepper_ps_template_stepper_template_module__WEBPACK_IMPORTED_MODULE_8__["PsTemplateStepperModule"], _angular_router__WEBPACK_IMPORTED_MODULE_2__["RouterModule"].forChild(routes), src_app_commonSRC_psComponents_ps_components_module__WEBPACK_IMPORTED_MODULE_7__["PsComponentsModule"], src_app_commonBussinessSRC_psComponents_ps_select_dropdown_ps_dropdown_currencies_ps_dropdown_currencies_component_module__WEBPACK_IMPORTED_MODULE_6__["PsDropdownCurrenciesComponentModule"], src_app_commonBussinessSRC_psComponents_ps_keyin_input_ps_input_varchar_ps_input_varchar_component_module__WEBPACK_IMPORTED_MODULE_4__["PsInputVarcharComponentModule"], src_app_commonBussinessSRC_psComponents_ps_lookup_ps_lookup_own_accounts_ps_lookup_own_accounts_component_module__WEBPACK_IMPORTED_MODULE_5__["PsLookupOwnAccountComponentModule"], src_app_commonBussinessSRC_psComponents_ps_accounts_list_ps_accounts_list_component_module__WEBPACK_IMPORTED_MODULE_3__["PsAccountsListComponentModule"]],
        declarations: [_demand_draft_page__WEBPACK_IMPORTED_MODULE_10__["DemandDraftPage"]]
      })], DemandDraftPageModule);
      /***/
    }
  }]);
})();
//# sourceMappingURL=pages-demand-draft-demand-draft-module-es5.js.map