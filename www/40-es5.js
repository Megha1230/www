(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([[40], {
    ...
    function UtLR(module, __webpack_exports__, __webpack_require__) {
      ...
      var ContactPage = /*#__PURE__*/function (_omni_base_omni_base_) {
        function ContactPage(commonService, logger, navService, omniPull) {
          var _this;

          _classCallCheck(this, ContactPage);

          _this = _callSuper(this, ContactPage);
          _this.commonService = commonService;
          _this.logger = logger;
          _this.navService = navService;
          _this.omniPull = omniPull;
          _this.formGroup = new _angular_forms__WEBPACK_IMPORTED_MODULE_4__["FormGroup"]({});
          _this.contactDetailsVO = {};
          _this.panelNotificationContactOptions = {
            isExpandable: true,
            labelKey: 'notification_contact_key',
            expanded: true
          };
          _this.emailNotificationOptions = {
            labelKey: 'email_key',
            placeHolder: 'email_key',
            fcName: 'email',
            group: _this.formGroup
          };
          _this.phoneNumberNotificationOptions = {
            fcName: 'mobileNumber',
            group: _this.formGroup
          };
          _this.stepperOptions = {
            ...
            numberOfSteps: 1,
            namesofSteps: ['contact_details_step1'],
            group: _this.formGroup,
            submitOptions: {
              ...
              postCallFunction: {
                func: function func(response) {
                  ...
                  return new Promise(function (resolve, reject) {
                    resolve(_this2.executionClass.updateContactInfo(response));
                  });
                },
            ...
            requestObject: _this.contactDetailsVO
          };
          return _this;
        }

        _inherits(ContactPage, _omni_base_omni_base_);

        return _createClass(ContactPage, [{
          key: "ngOnInit",
          value: function ngOnInit() {
            _superPropGet(ContactPage, "init", this, 3)([]);
            ...
            if (src_app_commonSRC_psServices_models_common_utils__WEBPACK_IMPORTED_MODULE_10__["CommonUtils"].isEmptyObject(this.navService.getAllParams())) {
              ...
              var subscriberInfo = this.commonService.session.getValueOf(src_app_commonSRC_psServices_models_common_constant__WEBPACK_IMPORTED_MODULE_9__["ConstantCommon"].SUBSCRIBER_INFO);
                ...
                while (1) switch (_context.n) {
                  case 0:
                    this.omniPull.returnSubscriberDetails().then(function (userInformation) {
                      _this3.commonInfoHandling(userInformation.subscriberInfo);

                      _this3.commonProv.dismissLoading();
                    })["catch"](function (error) {
                      return _this3.commonProv.logger.log(error);
                    });
          ...
          value: function updateContactInfo(response) {
            if (response.outputCode == 0 || response.outputType === 'S') {
              ...
              this.commonProv.session.append(src_app_commonSRC_psServices_models_common_constant__WEBPACK_IMPORTED_MODULE_9__["ConstantCommon"].SUBSCRIBER_INFO, {
