...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "DynamicComponentPageLoaderPage", function() { return DynamicComponentPageLoaderPage; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "mrSG");
/* harmony import */ var _raw_loader_dynamic_component_page_loader_page_html__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! raw-loader!./dynamic-component-page-loader.page.html */ "4Ojc");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/core */ "fXoL");
/* harmony import */ var _angular_forms__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @angular/forms */ "3Pt+");
/* harmony import */ var src_app_commonBussinessSRC_psServices_integration_ps_integration_constants__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! src/app/commonBussinessSRC/psServices/integration/ps-integration-constants */ "MNPF");
...
/* harmony import */ var src_app_commonSRC_psServices_models_ps_common_interface__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! src/app/commonSRC/psServices/models/ps-common-interface */ "DUM0");
...
let DynamicComponentPageLoaderPage = class DynamicComponentPageLoaderPage extends _omni_base_omni_base_page__WEBPACK_IMPORTED_MODULE_8__["OmniBasePage"] {
    constructor(navService) {
                ...
                postCallFunction: {
                    func() {
                        return new Promise((resolve, reject) => {
                            this.executionClass.commonProv.events.publish('draft:refresh');
                            resolve(true);
                        });
                    },
                    executionClass: this,
        ...
        this.types = src_app_commonSRC_psServices_models_ps_common_interface__WEBPACK_IMPORTED_MODULE_6__["IDynamicComponentPageLoader"];
        ...
        this.inAppUrlOptions = {
            url: null,
        };
    }
    ngOnInit() {
        const params = this.navService.getAllParams();
        const component = src_app_commonSRC_psServices_models_common_utils__WEBPACK_IMPORTED_MODULE_5__["CommonUtils"].valFromNestedObj('JBPM.screenMarkup.queryParams.componentName.MAP_VALUE', params);
        if (component) {
            this.component = component;
            this.options.submitOptions.extraParams = Object.assign(Object.assign({}, this.options.submitOptions.extraParams), { componentName: component });
            const queryParams = src_app_commonSRC_psServices_models_common_utils__WEBPACK_IMPORTED_MODULE_5__["CommonUtils"].valFromNestedObj('JBPM.screenMarkup.queryParams', params);
            if (component == this.types.CallSlot) {
            }
            if (component == this.types.Specimen) {
            }
            if (component == this.types.PSURL) {
                const url = queryParams['inapp-url.url'].MAP_VALUE;
                const type = queryParams['inapp-url.type'].MAP_VALUE;
...
DynamicComponentPageLoaderPage.ctorParameters = () => [
    { type: src_app_commonSRC_psServices_navigator_ps_navigator_service__WEBPACK_IMPORTED_MODULE_7__["PsNavigatorService"] }
];
DynamicComponentPageLoaderPage = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    ...
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:paramtypes", [src_app_commonSRC_psServices_navigator_ps_navigator_service__WEBPACK_IMPORTED_MODULE_7__["PsNavigatorService"]])
], DynamicComponentPageLoaderPage);
