(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([[56], {
    ...
    /***/
    function Tqe6(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function anDU(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "PrepaidCardRequestPage", function () {
        return PrepaidCardRequestPage;
      });
      /* harmony import */
      ...
      var _raw_loader_prepaid_card_request_page_html__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
      /*! raw-loader!./prepaid-card-request.page.html */
      "1Qpk");
      /* harmony import */


      var _prepaid_card_request_page_scss__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
      /*! ./prepaid-card-request.page.scss */
      "Tqe6");
      /* harmony import */
      ...
      var PrepaidCardRequestPage = /*#__PURE__*/function (_omni_base_omni_base_) {
        function PrepaidCardRequestPage(logger, navService, commonService, crdsSrvce, omniPull) {
          var _this;

          _classCallCheck(this, PrepaidCardRequestPage);

          _this = _callSuper(this, PrepaidCardRequestPage);
          _this.logger = logger;
          ...
          _this.stepperOptions = {
            ...
            requestObject: _this.prepaidCardRequestVO
          };
        ...
        _inherits(PrepaidCardRequestPage, _omni_base_omni_base_);

        return _createClass(PrepaidCardRequestPage, [{
          key: "ngOnInit",
          value: function ngOnInit() {
            _superPropGet(PrepaidCardRequestPage, "init", this, 3)([]);
          ...
          key: "checkMaxCardsNo",
          value: function checkMaxCardsNo() {
            var _this3 = this;

            this.omniPull.getParamValOf("MaximumPrepaidCardsAllowed").then(function (res) {
              _this3.maxCardsAllowed = res.MaximumPrepaidCardsAllowed;
            })["catch"](function (err) {
            ...
            this.crdsSrvce.returnCardList(paramData).then(function (result) {
              if (result && result.gridModel.length > 0) {
                if (result.gridModel.length > _this3.maxCardsAllowed || result.gridModel.length == _this3.maxCardsAllowed) {
                  src_app_commonSRC_psServices_models_common_utils__WEBPACK_IMPORTED_MODULE_10__["CommonUtils"].presentFailureAlert('maximum_prepaid_cards_allowed_reached', {
                    autoHide: false
                  }).then(function () {
                    ...
                    _this3.navService.navigateToMain();

                    _this3.commonService.dismissLoading();
                  });
                }
              }
            })["catch"](function (error) {
              _this3.logger.error('Error: While fetching prepaid cards list :', error);
            });
          }
        }, {
          key: "updateScreenVo",
      ...
      PrepaidCardRequestPage.ctorParameters = function () {
        return [{
      ...
      PrepaidCardRequestPage = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_3__["Component"])({
      ...
      }), Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:paramtypes", [src_app_commonSRC_psServices_logger_logger_service__WEBPACK_IMPORTED_MODULE_8__["LoggerService"], src_app_commonSRC_psServices_navigator_ps_navigator_service__WEBPACK_IMPORTED_MODULE_12__["PsNavigatorService"], src_app_commonSRC_psServices_ps_common_ps_common_service__WEBPACK_IMPORTED_MODULE_13__["PsCommonService"], src_app_commonBussinessSRC_psServices_Cards_cards_service__WEBPACK_IMPORTED_MODULE_5__["CardsService"], src_app_commonBussinessSRC_psServices_omni_common_omni_pull_service__WEBPACK_IMPORTED_MODULE_7__["OmniPullService"]])], PrepaidCardRequestPage);
      /***/
    },
