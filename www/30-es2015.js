...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ActivateSoftTokenOtpPage", function() { return ActivateSoftTokenOtpPage; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "mrSG");
/* harmony import */ var _raw_loader_activate_soft_token_otp_page_html__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! raw-loader!./activate-soft-token-otp.page.html */ "emUr");
/* harmony import */ var _activate_soft_token_otp_page_scss__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./activate-soft-token-otp.page.scss */ "+gGU");
...
let ActivateSoftTokenOtpPage = class ActivateSoftTokenOtpPage extends src_app_pages_omni_base_omni_base_page__WEBPACK_IMPORTED_MODULE_10__["OmniBasePage"] {
    constructor(navService, omniPull) {
        super();
        this.navService = navService;
        this.omniPull = omniPull;
        this.formGroup = new _angular_forms__WEBPACK_IMPORTED_MODULE_4__["FormGroup"]({});
        this.softTokenScreenVO = {};
        this.templateFormOptions = {
        ...
        this.stepperOptions = {
            ...
            submitOptions: {
                ...
                preCallFunction: {
                    func(response) {
                        return new Promise((resolve, reject) => {
                            resolve(this.executionClass.updateVO(response));
                        });
                    },
                    executionClass: this,
                    params: [this]
            ...
            requestObject: this.softTokenScreenVO,
            showReport: false
        };
        this.activateSoftTokenDetailsPanelOptions = {
            isExpandable: true,
            labelKey: 'activate_soft_token_otp_key',
            iconName: 'document',
            expanded: true
        };
        this.activateSoftTokenVascoPanelOptions = {
            isExpandable: true,
            labelKey: 'activate_soft_token_otp_key',
            iconName: 'document',
            expanded: true
        };
        this.activateSoftTokenStepsLblOptions = {
            fcName: 'activateSoftTokenSteps',
            labelKey: 'activate_soft_token_steps_key'
        };
        this.softTokenHintLblOptions = {
            fcName: 'softTokenHint',
            labelKey: 'soft_token_otp_can_be_activated_on_3_devices_at_maximum_key'
        };
        this.crontoDetailsPanelOptions = {
            isExpandable: true,
            labelKey: 'cronto_details_key',
            iconName: 'document',
            expanded: true
        };
        this.complexVascoSoftTokenOptions = {
    ...
    ionViewDidEnter() {
        ...
        this.omniPull.getParamValOf(src_app_commonBussinessSRC_psServices_models_ps_common_bussiness_constant__WEBPACK_IMPORTED_MODULE_5__["CommonBussinessConstant"].ENABLE_SOFT_TOKEN_OTP).then(res => {
            if (res[src_app_commonBussinessSRC_psServices_models_ps_common_bussiness_constant__WEBPACK_IMPORTED_MODULE_5__["CommonBussinessConstant"].ENABLE_SOFT_TOKEN_OTP]) {
                this.complexVascoSoftTokenOptions.disableSoftTokenBtn = false;
                this.commonProv.applyDynScreenDisplay(src_app_commonSRC_psServices_models_common_constant__WEBPACK_IMPORTED_MODULE_8__["ConstantCommon"].ACTION_TYPE_READONLY, ['activate_soft_token_btn'], 0);
            }
        }).finally(() => {
...
ActivateSoftTokenOtpPage.ctorParameters = () => [
...
ActivateSoftTokenOtpPage = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
