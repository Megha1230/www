...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "PsComplexBeneficiaryDetailsComponentModule", function() { return PsComplexBeneficiaryDetailsComponentModule; });
...
/* harmony import */ var _ps_keyin_input_ps_input_account_number_ps_input_account_number_module__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../../ps-keyin-input/ps-input-account-number/ps-input-account-number.module */ "iNXY");
/* harmony import */ var _ps_keyin_input_ps_input_card_number_ps_input_card_number_component_module__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../../ps-keyin-input/ps-input-card-number/ps-input-card-number.component.module */ "gByX");
/* harmony import */ var _ps_keyin_input_ps_input_varchar_ps_input_varchar_component_module__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../../ps-keyin-input/ps-input-varchar/ps-input-varchar.component.module */ "oZQX");
/* harmony import */ var _ps_select_dropdown_ps_dropdown_currencies_ps_dropdown_currencies_component_module__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../../ps-select-dropdown/ps-dropdown-currencies/ps-dropdown-currencies.component.module */ "SiC0");
...
/* harmony import */ var _ps_complex_id_details_ps_complex_id_details_module__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ../ps-complex-id-details/ps-complex-id-details.module */ "F9YD");
/* harmony import */ var _ps_complex_beneficiary_details_component__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./ps-complex-beneficiary-details.component */ "HadF");
...
let PsComplexBeneficiaryDetailsComponentModule = class PsComplexBeneficiaryDetailsComponentModule {
};
PsComplexBeneficiaryDetailsComponentModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        declarations: [
            _ps_complex_beneficiary_details_component__WEBPACK_IMPORTED_MODULE_11__["PsComplexBeneficiaryDetailsComponent"]
        ],
        imports: [
            ...
            _ps_keyin_input_ps_input_varchar_ps_input_varchar_component_module__WEBPACK_IMPORTED_MODULE_7__["PsInputVarcharComponentModule"],
            _ps_complex_address_ps_complex_address_component_module__WEBPACK_IMPORTED_MODULE_9__["PsComplexAddressComponentModule"],
            _ps_keyin_input_ps_input_account_number_ps_input_account_number_module__WEBPACK_IMPORTED_MODULE_5__["PsInputAccountNumberComponentModule"],
            _ps_keyin_input_ps_input_card_number_ps_input_card_number_component_module__WEBPACK_IMPORTED_MODULE_6__["PsInputCardNumberComponentModule"],
            _ps_select_dropdown_ps_dropdown_currencies_ps_dropdown_currencies_component_module__WEBPACK_IMPORTED_MODULE_8__["PsDropdownCurrenciesComponentModule"],
            ...
            _ps_complex_id_details_ps_complex_id_details_module__WEBPACK_IMPORTED_MODULE_10__["PsComplexIdDetailsModule"]
        ],
        exports: [
            _ps_complex_beneficiary_details_component__WEBPACK_IMPORTED_MODULE_11__["PsComplexBeneficiaryDetailsComponent"]
        ],
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "PsComplexBeneficiaryDetailsComponent", function() { return PsComplexBeneficiaryDetailsComponent; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "mrSG");
/* harmony import */ var _raw_loader_ps_complex_beneficiary_details_component_html__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! raw-loader!./ps-complex-beneficiary-details.component.html */ "SSCn");
/* harmony import */ var _ps_complex_beneficiary_details_component_scss__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./ps-complex-beneficiary-details.component.scss */ "jBjM");
...
/* harmony import */ var _psServices_omni_common_omni_common_service__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./../../../psServices/omni-common/omni-common.service */ "0CJq");
...
/* Islam 21012020 */
let PsComplexBeneficiaryDetailsComponent = class PsComplexBeneficiaryDetailsComponent extends src_app_commonSRC_psComponents_ps_base_ps_base_field_ps_base_field_component__WEBPACK_IMPORTED_MODULE_6__["PsBaseFieldComponent"] {
    constructor(commonProv, omniPull, logger, omniCommon) {
    ...
    ngOnInit() {
        ...
        // set the reference of requestObject in defaultOptions to be same as the one of this.options as the copyobject will 
        ...
        if ((src_app_commonSRC_psServices_models_ps_common_settings__WEBPACK_IMPORTED_MODULE_10__["PsCommonSettings"].oper_ID == src_app_commonBussinessSRC_psServices_models_ps_common_bussiness_constant__WEBPACK_IMPORTED_MODULE_4__["CommonBussinessConstant"].BANK_CARD_BENEFICIARY_OPER_ID)
            || (src_app_commonSRC_psServices_models_ps_common_settings__WEBPACK_IMPORTED_MODULE_10__["PsCommonSettings"].oper_ID == src_app_commonBussinessSRC_psServices_models_ps_common_bussiness_constant__WEBPACK_IMPORTED_MODULE_4__["CommonBussinessConstant"].LOCAL_CARD_BENEFICIARY_OPER_ID)) {
            this.isCardBenef = true;
        }
    }
    validateBeneficiary(value) {
        ...
        if (this.options.validateBeneficiary) {
            ...
            this.omniCommon.validateBeneficiary(request).then(result => {
                this.common.dismissLoading();
                src_app_commonSRC_psServices_models_common_utils__WEBPACK_IMPORTED_MODULE_9__["CommonUtils"].deleteError(this.options.benefAccountNumberOptions.group, this.options.benefAccountNumberOptions.fcName);
                src_app_commonSRC_psServices_models_common_utils__WEBPACK_IMPORTED_MODULE_9__["CommonUtils"].deleteError(this.options.benefNameOptions.group, this.options.benefNameOptions.fcName);
            }).catch(error => {
                this.common.dismissLoading();
                this.options.requestObject[this.defaultOptions.benefAccountNumberOptions.fcName] = null;
                this.options.requestObject[this.defaultOptions.currencyOptions.fcName] = null;
                this.options.requestObject[this.defaultOptions.benefNameOptions.fcName] = null;
                this.options.benefAccountNumberOptions.group.controls[this.defaultOptions.benefAccountNumberOptions.fcName].setErrors({ 'invalid': true });
                this.options.benefAccountNumberOptions.group.controls[this.defaultOptions.benefAccountNumberOptions.fcName]['oldValue'] = null;
                this.options.benefAccountNumberOptions.group.controls[this.defaultOptions.benefAccountNumberOptions.fcName]['innerValue'] = null;
                if (error && error.data.outputType === src_app_commonSRC_psServices_models_common_constant__WEBPACK_IMPORTED_MODULE_8__["ConstantCommon"].OUT_PUT_TYPE_U) {
                    src_app_commonSRC_psServices_models_common_utils__WEBPACK_IMPORTED_MODULE_9__["CommonUtils"].setErrors(this.options.benefAccountNumberOptions.group, this.options.benefAccountNumberOptions.fcName, [{ msgKey: error.data.outputNotification }]);
                }
                else {
...
PsComplexBeneficiaryDetailsComponent.ctorParameters = () => [
...
PsComplexBeneficiaryDetailsComponent = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    ...
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:paramtypes", [src_app_commonSRC_psServices_ps_common_ps_common_service__WEBPACK_IMPORTED_MODULE_11__["PsCommonService"], src_app_commonBussinessSRC_psServices_omni_common_omni_pull_service__WEBPACK_IMPORTED_MODULE_5__["OmniPullService"], src_app_commonSRC_psServices_logger_logger_service__WEBPACK_IMPORTED_MODULE_7__["LoggerService"],
        _psServices_omni_common_omni_common_service__WEBPACK_IMPORTED_MODULE_12__["OmniCommonService"]])
...
//# sourceMappingURL=default~pages-cash-beneficiary-cash-beneficiary-module~pages-internal-beneficiary-internal-beneficia~b709636e-es2015.js.map