(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["default~pages-add-owner-add-owner-module~pages-dynamic-component-page-loader-dynamic-component-page-~5fe6615e"], {
    ...
    function p(module, __webpack_exports__, __webpack_require__) {
      ...
      __webpack_require__.d(__webpack_exports__, "PsComplexSpecimenComponent", function () {
        return PsComplexSpecimenComponent;
      });
      /* harmony import */
      ...
      var _raw_loader_ps_complex_specimen_component_html__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
      /*! raw-loader!./ps-complex-specimen.component.html */
      "nMK/");
      /* harmony import */
      ...
      var src_app_commonBussinessSRC_psServices_omni_common_omni_pull_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
      ...
      var src_app_commonSRC_psComponents_ps_base_ps_base_field_ps_file_upload_ps_file_upload_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
      /*! src/app/commonSRC/psComponents/ps-base/ps-base-field/ps-file-upload/ps-file-upload.component */
      "UWqY");
      /* harmony import */
      ...
      var PsComplexSpecimenComponent = PsComplexSpecimenComponent_1 = /*#__PURE__*/function (_src_app_commonSRC_ps) {
        function PsComplexSpecimenComponent(commonProv, omniPull, logger) {
          var _this;

          _classCallCheck(this, PsComplexSpecimenComponent);

          _this = _callSuper(this, PsComplexSpecimenComponent, [commonProv, logger]);
          _this.commonProv = commonProv;
          _this.omniPull = omniPull;
          _this.logger = logger; // scanUploadButton: IOptionsPsActionButton = {
          ...
          _this.defaultPadSignatureOptions = {};
          _this.handWriting = 0;
          _this.itemOptions = {
        ...
        _inherits(PsComplexSpecimenComponent, _src_app_commonSRC_ps);

        return _createClass(PsComplexSpecimenComponent, [{
          ...
          key: "showPadSignature",
          value: function showPadSignature(value) {
            this.handWriting = value;
          }
        }, {
          key: "cancelClicked",
          value: function cancelClicked() {
            this.handWriting = 0; // this.defaultCaptureImageButtonOptions.imageBase64Url = null;
            // this.defaultCaptureImageButtonOptions.labelKey = 'browse_scan_signature_key';

            var padSigName = this.defaultPadSignatureOptions.fcName;
            var specUploadName = this.specimenScanUploadOptions.fcName;
          ...
          key: "setEntityFormGroup",
          value: function setEntityFormGroup() {
            this.commonProv.setFormData(this.entityFormGroup, this.entityVO);
          }
        }, {
          key: "signaturePageChanged",
          value: function signaturePageChanged(data) {
            if (data.newValue) {
          ...
          key: "uploadScanChanged",
          value: function uploadScanChanged(data) {
          ...
          */
          ...
          key: "setFromSavedData",
          value: function setFromSavedData(controlOptions, setVal) {
          ...
          */
          ...
          key: "initializeFromSavedData",
          value: function initializeFromSavedData() {
            var _this2 = this;

            if (this.options.dataObservable) {
              this.options.dataObservable.subscribe(function (result) {
                if (result) {
                  _this2.savedData = result;
                  var specVal = _this2.options.group.controls[src_app_commonSRC_psServices_models_common_constant__WEBPACK_IMPORTED_MODULE_7__["ConstantCommon"].CONTROLLER_FORM_DATA].value[_this2.options.fcName];

                  if (specVal) {
                    if (specVal[0]['fileSize']) {
                      _this2.commonProv.setValInsideNestedObj(_this2.specimenScanUploadOptions.fcName, specVal, _this2.entityVO);

                      _this2.showPadSignature(1); //Makki:AZDB-5092 In case current sign is a file , show it  on open

                    } else {
                      _this2.commonProv.setValInsideNestedObj(_this2.defaultPadSignatureOptions.fcName, specVal, _this2.entityVO);

                      _this2.showPadSignature(2); //Makki:AZDB-5092 In case current sign is a drawing , show the drawing pad on open
          ...
          key: "deleteCurrentSign",
          value: function deleteCurrentSign() {
            this.setEntityValue([]);
            this.setControlValue(this.specimenScanUploadOptions.fcName, [], this.entityVO);
          }
        }, {
          key: "setControlValue",
          value: function setControlValue(fcName, value, requestObject) {
      ...
      PsComplexSpecimenComponent.ctorParameters = function () {
        return [{
    ...
    /***/
    function DtgQ(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "PsComplexSpecimenComponentModule", function () {
        return PsComplexSpecimenComponentModule;
      });
      /* harmony import */
      ...
      var _ps_complex_specimen_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
      /*! ./ps-complex-specimen.component */
      "89p+");

      var PsComplexSpecimenComponentModule = /*#__PURE__*/_createClass(function PsComplexSpecimenComponentModule() {
        _classCallCheck(this, PsComplexSpecimenComponentModule);
      });

      PsComplexSpecimenComponentModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        declarations: [_ps_complex_specimen_component__WEBPACK_IMPORTED_MODULE_4__["PsComplexSpecimenComponent"]],
        ...
        exports: [_ps_complex_specimen_component__WEBPACK_IMPORTED_MODULE_4__["PsComplexSpecimenComponent"]],
        entryComponents: [_ps_complex_specimen_component__WEBPACK_IMPORTED_MODULE_4__["PsComplexSpecimenComponent"]],
    ...
    /***/
    function nMK_(module, __webpack_exports__, __webpack_require__) {
      "use strict";
...
//# sourceMappingURL=default~pages-add-owner-add-owner-module~pages-dynamic-component-page-loader-dynamic-component-page-~5fe6615e-es5.js.map